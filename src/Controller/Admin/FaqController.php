...
class FaqController extends AppController
{
	...
	public function index()
	{
		...
		$faq_cat = $this->faq_cat->find('all')->order(['faq_cat.id'])->toarray();
	...
	public function question()
	{
		...
		$this->loadModel('Faq');
		$faq_cat_question = $this->FaqCatQuestion->find('all')->contain(['Faq'])->order(['FaqCatQuestion.id' => 'DESC'])->toarray();
		$this->set('faq_cat_question',$faq_cat_question);
	...
	public function delete($id)
	{
		...
		if ($catdelete) {
			...
			$this->FaqCatQuestion->deleteAll(['FaqCatQuestion.faq_cat_id' => $id]);
	...
	//	$this->viewBuilder()->layout('admin');
		...
		$faq_cat_question = $this->FaqCatQuestion->find()->where([$cond])->contain(['Faq'])->order(['FaqCatQuestion.created' => 'desc'])->toarray();
		$this->set('faq_cat_question', $faq_cat_question);
	}
}
