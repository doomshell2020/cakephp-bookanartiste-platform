...
{       
	...
	public function index(){ 
        ...
        $contentadmin = $this->Users->find('all')->contain(['Skillset'])->where(['Users.role_id'=>Talentsub_admin])->order(['Users.id' => 'DESC'])->toarray();
    ...
    {   
            ...
            $this->loadModel('Users');
            $telantadmin = $this->Users->find('all')->where(['Users.role_id'=>Talent_admin])->order(['Users.id' => 'DESC'])->toarray();
            ...
            $this->request->data['role_id']= Talentsub_admin;
