...
class EmailComponent extends Component
{
    ...
    public function send($to, $subject, $message,  $cc = null)
    {
        ...
        $sender = "infobookanartiste@gmail.com"; // this will be overwritten by GMail
        ...
        try {
            ...
            $rt ="3"; //Catch errors from Amazon SES.
        }
        return $rt;
    }
}
