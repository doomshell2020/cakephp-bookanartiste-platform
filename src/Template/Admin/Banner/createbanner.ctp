        ...
        <div class="box">
          ...
          <div class="box-body  table-responsive">
            <div class="manag-stu">
              ...
              <div class="form-group">
                <label for="" class="col-sm-3 control-label">Set as default image</label>
                <div class="col-sm-8">
                  <label for="male">Yes</label>
                  <input name="is_default_image" type="checkbox" class="group1 checkboxx" value="1" />
                  <label for="female">No</label>
                  <input name="is_default_image" type="checkbox" class="group1 checkboxx" value="0" checked />
                </div>
                <div class="col-sm-1"></div>
              </div>
                ...
                <div class="col-sm-8">
                  <div class="row">
                    <div class="col-sm-5 date">
                      ...
                      <?php echo $this->Form->input('banner_date_from', array('class' => 'form-control datetimepicker1', 'placeholder' => 'MM DD, YYYY', 'type' => 'text', 'required' => true, 'label' => false, 'id' => 'event_from_date', 'onchange' => "return validateform()", 'value' => (!empty($requirement['event_from_date'])) ? date('M d, Y H:m', strtotime($requirement['event_from_date'])) : '')); ?>
...
<script>
  $('.checkboxx').click(function(e) {
    var val = $(this).val();
    if (val == 1) {
      $('.datetimepicker1').removeAttr('required');
