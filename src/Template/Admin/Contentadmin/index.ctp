  ...
  <div class="content-wrapper">
	...
	<div class="box">
            <div class="box-header">
              <h3 class="box-title"> Content Admin</h3>           
            </div>
...
Add Content Admin </button></a>
		...
		?>
                <tr>
                  ...
                  <td><a data-toggle="modal" class='skill'  href="<?php echo ADMIN_URL?>profile/skill/<?php echo $admin['id']; ?>" style="color:blue;">Details</a></td>
