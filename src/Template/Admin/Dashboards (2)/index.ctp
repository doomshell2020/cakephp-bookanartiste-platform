              ...
              <div class="box box-danger">
                ...
                <div class="box-body no-padding">
                  <ul class="users-list clearfix">
                    ...
                    <li>
                      <img src="<?php echo SITE_URL; ?>/profileimages/<?php echo $members['profile'][0]['profile_image']; ?>" alt="<?php echo $members['profile'][0]['name']; ?>">
                      <a class="users-list-name" href="#"><?php echo $members['profile'][0]['name']; ?></a>
            ...
            <div class="box-body">
              <div class="table-responsive">
                <table class="table no-margin">
                  ...
                  <tr>
                    <td><a href="pages/examples/invoice.html"><?php echo $jobs['id']; ?></a></td>
                    <td><?php echo $jobs['title']; ?></td>
                    <td><?php echo $jobs['event_from_date']; ?></td>
                    <td><?php echo $jobs['event_to_date']; ?></td>
                    <td><?php echo $jobs['city']; ?>,<?php echo $jobs['state']; ?>,<?php echo $jobs['country']; ?></td>
                  </tr>
                  <?php }?>
                  </tbody>
                </table>
