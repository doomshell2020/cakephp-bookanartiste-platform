...
<section class="content-header">
 ...
 Event Type Manager
   ...
   <ol class="breadcrumb">
      ...
      <li><a href="<?php echo SITE_URL; ?>/admin/eventtype">Event </a></li>
   </ol>
</section>
   ...
   <div class="row">
      ...
      <div class="row">
         <div class="col-xs-12">
            <div class="box">
                        <div class="clearfix">
<a href="<?php echo SITE_URL; ?>/admin/eventtype/add">
<button class="btn btn-success pull-right m-top10"><i class="fa fa-plus" aria-hidden="true"></i>
Add Event type </button></a>

</div>
               <div class="box-header">
                  <h3 class="box-title">Event Type Manager</h3>
               </div>
               <!-- /.box-header -->
               <div class="box-body">
