                      ...
                      <td>
                        <?php if ($faq['status'] == 'Y') {
                          echo $this->Html->link('', [
                            ...
                            $faq->id, 'N'
                          ], ['title' => 'Active', 'class' => 'fa fa-check-circle', 'style' => 'font-size: 16px !important; margin-right: 3px;color: #36cb3c;']);
                        } else {
                          echo $this->Html->link('', [
                            'action' => 'question_status', $faq->id, 'Y'
                          ], ['title' => 'Inactive', 'class' => 'fa fa-times-circle-o', 'style' => 'font-size: 16px !important; margin-right: 3px; color:#FF5722;']);
                        } ?>

                        <?php echo $this->Html->link(__(''), ['action' => 'question_edit', $faq->id,], array('class' => 'fa fa-pencil-square-o fa-lg', 'title' => 'Edit', 'style' => 'font-size: 16px !important; margin-right: 3px;')) ?>

                        <?php echo $this->Html->link('', ['action' => 'question_delete', $faq->id], ['title' => 'Delete', 'class' => 'fa fa-trash', 'style' => 'color:#FF0000; font-size: 16px !important; margin-right: 3px;', "onClick" => "javascript: return confirm('Are you sure do you want to delete this FAQ Question?')"]); ?>
