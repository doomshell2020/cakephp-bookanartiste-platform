  ...
  $("#TaskAdminCustomerForm").bind("submit", function (event) {
    $.ajax({
      ...
      success:function (data, textStatus) {
        ...
        $("#example2").html(data);}, 
        type:"POST", 
        url:"<?php echo ADMIN_URL ;?>featurejobpack/search"});
    return false;
  });
});
//]]>
...
<a href="<?php echo ADMIN_URL; ?>featurejobpack/featurejoexcel" type="reset" class="btn btn-warning pull-right">Export Excel</a>
                  ...
                  foreach($Job as $admin){  //pr($admin); 
                   ...
                   // echo $admin['feature_job_date'];
                    ...
                    <tr>
                      ...
                      <td><?php if($admin['feature_job_date']){ echo date('M d,Y',strtotime($featstart)); }else{ echo "N/A"; } ?></td>
                      <td><?php if($admin['expiredate']){ echo date('M d,Y',strtotime($expiredate)); }else{ echo "N/A"; } ?></td>                      
                      <td>
                        <?php 
