...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>Featured Profile Package</h1>
        ...
        <div class="box">
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="clearfix">
                  <a href="<?php echo SITE_URL; ?>/admin/featureprofilepack/add">
                    <button class="btn btn-success pull-right m-top10"><i class="fa fa-plus" aria-hidden="true"></i>
                      Add Featured Profile Package </button></a>
                    ...
                    <tbody>
                      ...
                      ?>
                          <tr>
                            ...
                            <td> <?php if (isset($pack['id'])) {
                                    if ($pack['is_default'] == 'Y') {
                                      echo "Default ";
                                    }
                                    echo ucfirst($pack['name']);
                                  } else {
                                    echo 'N/A';
                                  } ?>
                            </td>
                            ...
                            <td><?php if (isset($pack['priorites'])) {
                                  echo $pack['priorites'];
                                } else {
                                  echo '0';
                                } ?>
