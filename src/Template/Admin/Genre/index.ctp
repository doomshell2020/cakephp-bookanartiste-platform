                        ...
                        if (isset($Genre) && !empty($Genre)) {
                           foreach ($Genre as $genre) {  ?>
                              <tr>
                                 ...
                                 <td>
                                 <a 
                                 href="<?php echo ADMIN_URL; ?>genre/delete/<?=$genre['id']; ?>" 
                                    onClick="javascript:return confirm('Are you sure do you want to delete this')">
                                    <img src="<?php echo SITE_URL; ?>/img/del.png">
                                 </a>
                                    <?php
                                    ...
                                    <br>
                                    <a href="<?php echo SITE_URL ?>/admin/subgenre/index/<?php echo $genre['id'] ?>">Add/Edit Sub Genre</a>
