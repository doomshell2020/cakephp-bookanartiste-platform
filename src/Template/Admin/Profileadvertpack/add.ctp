        ...
        <div class="col-md-12">
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title"><?php if(isset($packentity['id'])){ echo 'Edit Profile Advertisement Package'; }else{ echo 'Add Profile Advertisement Package';} ?></h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
