      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Update Profile Advertisement Price</h3>
          </div>
  ...
  $("#TaskAdminCustomerForm").bind("submit", function (event) {
    $.ajax({
      ...
      success:function (data, textStatus) {
        ...
        $("#example2").html(data);}, 
        type:"POST", 
        url:"<?php echo ADMIN_URL ;?>profileadvertpack/search"});
    return false;
  });
});
//]]>
...
<a href="<?php echo ADMIN_URL; ?>profileadvertpack/advrtproexcel"  class="btn btn-warning pull-right">Export Excel</a>
...
<div class="row">
  <div class="col-xs-12">
    <div class="box">
      <div class="box-header">
        <h3 class="box-title">Manage Profile Advertisement</h3>
      </div>
          ...
          <tbody id="example2">
            ...
            if(isset($alladvtpro) && !empty($alladvtpro)){ 
              foreach($alladvtpro as $pack){  //pr($pack); die;
                ...
                ?>
                <tr>
                  <td><img src="<?php echo SITE_URL; ?>/profileimages/<?php echo $pack['job_image_change'] ?>" alt=""> </td>
                  ...
                  <td><?php if($pack['status']=='Y'){ ?>
                    ...
                    <td><?php if($pack['status']=='Y'){ 
                      echo $this->Html->link('Deactivate Ad', [
                        ...
                        echo $this->Html->link('Activate Ad', [
                          'action' => 'status',
                            $pack['id'],
                           $pack['status']
