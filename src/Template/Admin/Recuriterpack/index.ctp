        ...
        <div class="box">
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="clearfix">
                  <a href="<?php echo SITE_URL; ?>/admin/recuriterpack/add">
                ...
                <div class="box-body">
                  <table id="" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php
                      $counter = 1;
                      if (isset($RecuriterPack) && !empty($RecuriterPack)) {
                        foreach ($RecuriterPack as $pack) {

                      ?>
                          <tr>
                            <td><?php echo $counter; ?></td>
                            <td> <a data-toggle="modal" class='pack' href="<?php echo ADMIN_URL ?>recuriterpack/profilepackdata/<?php echo $pack['id']; ?>" style="color:#1e89d9;"><?php if (isset($pack['id'])) {
                                                                                                                                                                                  echo ucfirst($pack['title']);
                                                                                                                                                                                } else {
                                                                                                                                                                                  echo 'N/A';
                                                                                                                                                                                } ?> </a></td>
