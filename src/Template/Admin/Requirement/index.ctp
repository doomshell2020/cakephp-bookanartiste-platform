...
<section class="content-header">
 ...
 Requirement Manager
   ...
   <ol class="breadcrumb">
      ...
      <li><a href="<?php echo SITE_URL; ?>/admin/requirement">Requirement </a></li>
   </ol>
</section>
   ...
   <div class="row">
      ...
      <div class="row">
         <div class="col-xs-12">
            <div class="box">
                        <div class="clearfix">
<a href="<?php echo SITE_URL; ?>/admin/requirement/add">
<button class="btn btn-success pull-right m-top10"><i class="fa fa-plus" aria-hidden="true"></i>
Add Requirement </button></a>

</div>
               <div class="box-header">
                  <h3 class="box-title">Requirement Manager</h3>
               </div>
               <!-- /.box-header -->
               <div class="box-body">
                  <table id="example" width="100%"   class="table table-bordered table-striped">
                     ...
                     <tbody>
                        <?php
                           $counter =  1;
                           if(isset($RequirementPack) && !empty($RequirementPack)){ 
                           foreach($RequirementPack as $Country){   ?>
                        <tr>
                           <td><?php echo $counter;?></td>
                           <td>
                              <?php echo $Country['name']; ?>
                           </td>
                       <td><?php echo $Country['number_of_days']; ?></td>
                       <td><?php echo $Country['number_of_talent_type']; ?></td>
                       <td><?php echo $Country['price']; ?></td>
                       <td><?php echo $Country['priorites']; ?></td>
                           ...
                           <td>
                              <a href="<?php echo ADMIN_URL;?>requirement/delete/<?= 
