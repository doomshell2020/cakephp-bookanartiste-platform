		...
		<?php echo $this->Form->create($sitesetting , array(
		  ...
		  <div class="form-group">
			...
			<?php echo $this->Form->input('facebook_url',array('class'=>'form-control','placeholder'=>'Facebook URL', 'id'=>'facebook_url','label' =>false)); ?>
		        	...
		        	<div class="form-group">
		          <label for="inputEmail3" class="col-sm-2 control-label">Instagram URL</label>

		          <div class="col-sm-10">
			<?php echo $this->Form->input('instagram',array('class'=>'form-control','placeholder'=>'Instagram URL', 'id'=>'instagram','label' =>false)); ?>
		          ...
		          <div class="col-sm-10">
			<?php echo $this->Form->input('google_plus',array('class'=>'form-control','placeholder'=>'Google+ URL', 'id'=>'google_plus','label' =>false)); ?>
			...
			<?php echo $this->Form->textarea('google_analytics',array('class'=>'form-control','placeholder'=>'Google Analytics', 'id'=>'google_analytics','label' =>false)); ?>
		   	 ...
		   	 <div class="form-group">
		          ...
		          <div class="col-sm-10">
			<?php echo $this->Form->textarea('address',array('class'=>'form-control','placeholder'=>'Address','maxlength'=>'110','label' =>false)); ?>
		           
		          </div>
		        </div>
		        
		           	 <div class="form-group">
		          <label for="inputEmail3" class="col-sm-2 control-label">Tag Line For Guest Artist</label>

		          <div class="col-sm-10">
			<?php echo $this->Form->textarea('gartist',array('class'=>'form-control','placeholder'=>'Tag Line For Guest Artist','maxlength'=>'100','label' =>false)); ?>
		           
		          </div>
		        </div>

		    <div class="form-group">
		          <label for="inputEmail3" class="col-sm-2 control-label">Talent Partner Commission</label>

		          <div class="col-sm-10">
			<?php echo $this->Form->textarea('tal_part_comm',array('class'=>'form-control','placeholder'=>'Talent Partner Commission','maxlength'=>'3','label' =>false)); ?>
				...
				<div class="form-group">
		          ...
		          <div class="col-sm-10">
			<?php echo $this->Form->input('banner_title',array('class'=>'form-control','placeholder'=>'Banner Title', 'id'=>'banner_title','label' =>false)); ?>
