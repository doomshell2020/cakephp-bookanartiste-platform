...
Add State </button></a>
                  ...
                  <table id="example" width="100%"   class="table table-bordered table-striped">
                     ...
                     <tbody>
                       ...
                       <td><?php echo $State['country']['name']; ?></td>
                           ...
                           <td>
                              <a href="<?php echo ADMIN_URL;?>state/delete/<?= 
                                 $State['id']?>" onClick="javascript:return confirm('Are you sure do you want to delete this')" ><img src="<?php  echo SITE_URL; ?>/img/del.png"></a>
                                 <?php
      ...
      <a class="action_btn" href="<?php echo ADMIN_URL;?>city/index/<?= 
                                 $State['id']?>" >View City</a>
                           </td>
                        </tr>
                        <?php $counter++;} }else{ ?>
                        <tr>
