...
<li><a href="#">Static Page  Manager</a></li>
...
Add </button></a> 
	...
	<div class="box">
            <div class="box-header">
              <h3 class="box-title">Static Page List</h3>
            </div>
            <!-- /.box-header -->
 ...
 <td><?php if(isset($Static['name'])){ echo ucfirst($Static['name']);}else{ echo 'N/A';}?></td>                
                
<td><a class="globalModals" href="<?php echo SITE_URL;?>/admin/static/description/<?php echo $Static['id'] ?>" data-target="#globalModal" data-toggle="modal"> View </td>
				       <td><?php if($Static['status']=='Y'){ 
            ...
            <td>
                <a href="<?php echo ADMIN_URL;?>static/delete/<?= 
                $Static['id']?>" onClick="javascript:return confirm('Are you sure do you want to delete this')" ><img src="<?php  echo SITE_URL; ?>/img/del.png"></a>
                <?php
