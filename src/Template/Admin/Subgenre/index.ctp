...
Sub Genre Manager
   ...
   <ol class="breadcrumb">
      ...
      <li><a href="<?php echo SITE_URL; ?>/admin/genre">Sub Genre</a></li>
   </ol>
</section>
   ...
   <div class="row">
      ...
      <div class="row">
         <div class="col-xs-12">
            <div class="box">
                        <div class="clearfix">
<a href="<?php echo SITE_URL; ?>/admin/subgenre/add">
<button class="btn btn-success pull-right m-top10"><i class="fa fa-plus" aria-hidden="true"></i>
Add Sub Genre </button></a>

</div>
               <div class="box-header">
                  <h3 class="box-title">Sub Genre Manager</h3>
               </div>
               <!-- /.box-header -->
               <div class="box-body">
                  <table id="example" width="100%"   class="table table-bordered table-striped">
                     ...
                     <tbody>
                       ...
                       <td><?php echo $genre['skill']['name']; ?></td>
                       
                         
                        
                           
                           <td><?php if($genre['status']=='Y'){ 
                           ...
                           <td>
                              <a href="<?php echo ADMIN_URL;?>genre/delete/<?= 
                                 $genre['id']?>" onClick="javascript:return confirm('Are you sure do you want to delete this')" ><img src="<?php  echo SITE_URL; ?>/img/del.png"></a>
                                 <?php
