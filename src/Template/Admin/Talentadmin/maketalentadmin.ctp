		...
		<div class="row">
		   ...
		   <div class="form-group">
		   	...
		   	<div class="form-group">
		   		...
		   		<div class="field col-sm-6">
		   			<?php echo $this->Form->input('country_id',array('class'=>'form-control','placeholder'=>'Country','id'=>'country_ids','required'=>true,'label' =>false,'empty'=>'--Select Country--','options'=>$country,'value'=>$usersProfile['country_ids'])); ?>
		   	...
		   	<div class="form-group">
		   		...
		   		<div class="field col-sm-6">
		   			...
		   			<?php echo $this->Form->input('state_id',array('class'=>'form-control','placeholder'=>'State','id'=>'state','required'=>true,'label' =>false,'empty'=>'--Select State--','options'=>$states,'value'=>$usersProfile['state_id'])); ?>
		   	...
		   	<div class="form-group">
		   		...
		   		<div class="field col-sm-6">
		   			...
		   			<?php echo $this->Form->input('city_id',array('class'=>'form-control','placeholder'=>'City','id'=>'city','required'=>true,'label' =>false,'empty'=>'--Select City--','options'=>$cities,'value'=>$usersProfile['city_id'])); ?>
		   	...
		   	<div class="form-group">
		   		...
		   		<div class="form-group">
		   			...
		   			<div class="field col-sm-6">
		   				...
		   				<input type="checkbox" value="Y" class="candelet" name="enable_delete_subadmin" <?php if($packentity['talent_admin']['enable_delete_subadmin']=='Y'){ echo "checked"; }?>> Can Delete and Edit Talent Partners</div>
		   			</div>
