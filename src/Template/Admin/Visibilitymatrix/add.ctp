  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
	    ...
	    <div class="field col-sm-6">
	    <?php echo $this->Form->input('short_name', array('class' => 
	    'form-control','required','placeholder'=>'Short Name','required','label'=>false,'type'=>'text','value'=>$question_info->short_name)); ?></div>
	    </div>
...
<div class="input text"><input type="text" name="datas[option_value][]" class="form-control" required="required" placeholder="Option Value" value="<?php echo $options['value']; ?>" id="question"></div>
</div>
 <div class="field col-sm-6">
