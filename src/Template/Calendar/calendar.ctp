...
<section id="page_alert" class="my_Calendar">
	<div class="container">
		<h2>My Calendar</h2>
		<p class="">An Effective Time Management Tool</p>
	</div>

	<div class="refine-search">
		<?php echo $this->Flash->render(); ?>
		<div class="container">
			<div class="m-top-20 profile-bg calendar_box clearfix">
				<div class="panel-right pull-left">
					<form>

						<div class="box member-detail alerts jobalertss">
				...
				<div class="panel panel-left pull-right">

					<div class="img_div"></div>
					<ul class="schedule-categry list-unstyled navff clearfix">

						<?php /* ?> <li class="pull-left"><span>Events</span></li>			<?php */ ?>
						<li class="">
							<?php /* ?>
							<a  class=" " href="javascript:;" onclick="add_event_information();" style="display: block; margin: 0 auto;  text-align: center; width: 67%;"><i class="fa fa-plus" aria-hidden="true"></i> Add to Calender</a> 
							<?php */ ?>

							<!-- <a data-toggle="modal" class='btn schedule-default skill' href="<?php echo SITE_URL ?>/calendar/addtocalendar" style="display: block; margin: 0 auto;  text-align: center; width: 67%;"><i class="fa fa-plus" aria-hidden="true"></i>Add to Calender</a> -->
							<a class='btn schedule-default' href="<?php echo SITE_URL ?>/calendar/addtocalendar" class="jobalerts" data-action="alerts" style="display: block; margin: 0 auto;  text-align: center;"><i class="fa fa-plus pluse_icon" aria-hidden="true"> </i>Add To Calendar </a>
						</li>
					...
					<ul class=" schedule-categrysec list-unstyled navff">
						...
						<li class="pending" style="background-color: #bf1717;"><a href="<?php echo SITE_URL ?>/calendar/pendingtask" class="jobalerts" data-action="alerts"><strong>View all pending task</strong><span ><?php echo  $totalpendingtask; ?></span></a></li>
						<ul class="">
							<li class=""><a href="<?php echo SITE_URL ?>/calendar/calendarlist/EV" class="jobalerts" data-action="alerts"><strong>Event</strong><span><?php echo count($userevent) ?></span></a></li>
							<li class="Remd"><a href="<?php echo SITE_URL ?>/calendar/calendarlist/RE" class="jobalerts" data-action="alerts"><strong>Reminder</strong><span><?php echo count($reminderevent) ?></span></a></li>

							<li class="todo"><a href="<?php echo SITE_URL ?>/calendar/calendarlist/TD" class="jobalerts" data-action="alerts"><strong>To Do</strong><span><?php echo count($todoevent) ?></span></a></li>
						</ul>

					</ul>
					<?php /* ?>
				<div class="calendar_color text-rigth"> 
						<ul class="text_right"> 
						<li>E <span class="c_green"></span></li>
						<li>To Do<span class="c_sky"></span></li>
						<li>R<span class="c_pink"></span></li>
						</ul>
						</div>
						<?php */ ?>
				</div>
...
?>
	...
	<div id="calender_section">
		<h2>
			<!--<a href="javascript:void(0);" onclick="get_calendar_data('calendar_div','<?php //echo date("Y",strtotime($date.' - 1 Month')); 
																							?>','<?php //echo date("m",strtotime($date.' - 1 Month')); 
																									?>');">&lt;</a>-->
