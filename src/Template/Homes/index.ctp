...
<section id="slider">
            ...
            <?php foreach ($banner as $homebanner) { ?>
                <div class="owl-item">
                    <div class="slide-caption2">
                        <?php if ($homebanner['title']) { ?>
                            <h1><?php echo $homebanner['title']; ?></h1>
                        <?php } else { ?>
                            <h1><?php echo $sitesetting['banner_title']; ?></h1>
                        <?php } ?>
                    </div>
                    <a class="banner_anchor" href="<?php echo $homebanner['bannerurl']; ?>">
                        <img src="<?php echo SITE_URL; ?>/bannerimages/<?php echo $homebanner['banner_image']; ?>" alt="">
                    </a>
                </div>
            <?php  }  ?>
    ...
    <?php  } else { //pr($default_banner); die;
    ?>
        <?php if ($default_banner['banner_image']) { ?>
            <div class="owl-item"><img src="<?php echo SITE_URL; ?>/bannerimages/<?php echo $default_banner['banner_image']; ?>" alt=""></div>
        <?php } else { ?>
    ...
    <div class="slide-caption">
        <?php if ($sitesetting['banner_title']) { ?>
            <h1><?php echo $sitesetting['banner_title']; ?></h1>
    ...
    <div class="serch-bar">
        ...
        <form method="get" accept-charset="utf-8" inputdefaults=" " class="form-horizontal" id="searchfrom" action="<?php echo SITE_URL ?>/search/search">
            <div class="form-group">
                ...
                <div class="col-sm-3 col-xs-6">
                    ...
                    <?php echo $this->Form->input('optiontype', array('class' => ' typesearch form-control', 'required' => true, 'label' => false, 'type' => 'select', 'options' => $opt, 'autocomplete' => 'off')); ?>
                </div>
                <div class="col-sm-2 col-xs-6">
                    <button type="submit" class="btn btn-default">Submit</button>
                </div>
                <div class="col-sm-3 col-xs-6"> <a href="<?php echo SITE_URL; ?>/search/advanceJobsearch" class="btn btn-primary btn-block" id="dynlink">Advance Search</a> </div>
            </div>
...
<!----------------------slider-bottom------------------------>
<?php //if ($this->request->session()->read('Auth.User.role_id')) { 
?>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4 text-right">
                ...
                <?php } else{ ?>
                <a href="#loginmodal" data-toggle="modal" onclick="assignloginaction('jobpost')" class="btn btn-info"
                    data-action="jobpost">Post Your Requirement</a>
                <?php } */ ?>
...
<!----------------------Featured Artistes---------------------->
<?php if (count($talent) > 0) { //pr($talent);exit; 
?>
    <section id="col_Featured">
        <div class="container">
            <h2><a href="<?php echo SITE_URL; ?>/featuredartist" target="_blank" style="text-align: center; color: #58595b;"> Featured <span>Profiles </a></span></h2>
            <p class="m-bott-50">Self Featured Profiles of Members</p>
            <?php if (count($talent) > 6) { ?>
                <div class="text-center m-top-20">
                    <a href="<?php echo SITE_URL; ?>/featuredartist" class="btn btn-default" target="_blank">View All</a>
                </div>
                <br>
                <br>
            <?php } //echo count($viewfeaturedartist); 
            ?>
            <div class="owl-carousel owl-theme owl-loaded featured-list-carousal">
                <?php
                $role_id = $this->request->session()->read('Auth.User.role_id');
                $count = 1;
                foreach ($viewfeaturedartist as $featuredartist) { //pr($featuredartist);die;
                    ...
                    $sabscriptionpr = $this->Comman->subscriptionpr($userid);
                    //pr($sabscriptionpr); die;
                ?>
                    <div class="owl-item profile-det">
                        <div class="profile-det-img">
                            <div class="hvr-icon">
                                <!-- <a href="#" class="fa fa-save"></a> <a href="#" class="fa fa-remove"></a> -->
                            </div>
                            <?php if ($featuredartist['profile_image']) { //echo "1"; 
                            ?>
                            ...
                            <?php } ?>
                            <?php if (isset($sabscriptionpr)) { ?>
                                <div class="img-top-bar"> <a href="<?php echo SITE_URL; ?>/profilepackage" class="fa fa-user" title="<?php echo $sabscriptionpr['Profilepack']['name'] . " Profile Package"; ?>"></a> </div>
                            <?php } ?>
                        ...
                        <div class="contact-detail-social-icon profile_action">
                            <ul class="list-unstyled">
                                ...
                                <li>
                                    ...
                                    <span class="dropdown">
                                        <?php if ($contactrequest == 'R') { ?>
                                            <a href="javascript:void(0)" style="color: yellow" class="fa fa-user-plus bg-blue bg-blue" data-toggle="tooltip" title="Request Received"></a>

                                        <?php } elseif ($contactrequest == 'S') { ?>
                                            <a href="javascript:void(0)" style="color: yellow" class="fa fa-user-plus bg-blue" data-toggle="tooltip" title="Request Sent"></a>

                                        <?php } elseif ($contactrequest == 'C') { ?>
                                            <a data-toggle="tooltip" title="Request Send" id="add_friend<?php echo $profile['user']['id']; ?>" class="managefriends<?php echo $count; ?> fa fa-handshake-o bg-blue" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" href="javascript:void(0)" data-val="<?php echo $profile['user']['id']; ?>" data-action="connect"></a>

                                        <?php } else { ?>
                                            <a data-toggle="tooltip" title="Request Send" id="add_friend<?php echo $profile['user']['id']; ?>" class="dropdown-toggle managefriends<?php echo $count; ?> fa fa-user-plus bg-blue" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" href="javascript:void(0)" data-val="<?php echo $profile['user']['id']; ?>" data-action="connect"> </a>
                                        <?php
                                        }
                                        ?>
                                </li>
                                <?php /* if($contactrequest=='R'){ ?>
                        <li>
                            <a href="javascript:void(0)" style="color: yellow" class="fa fa-user-plus bg-blue bg-blue"
                                title="Request Received"></a>
                        </li>
                        <?php }elseif($contactrequest=='S'){ ?>
                        <li>
                            <a href="javascript:void(0)" style="color: yellow" class="fa fa-user-plus bg-blue"
                                title="Request Sent"></a>
                        </li>
                        <?php }elseif($contactrequest=='C'){ ?>
                        <li>
                            <a id="add_friend<?php echo $profile['user']['id'];?>"
                                class="btn btn-default dropdown-toggle  managefriends fa fa-handshake-o bg-blue"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"
                                href="javascript:void(0)" data-val="<?php echo $profile['user']['id'];?>"
                                data-action="connect">ddddddddd</a>

                        </li>
                        <?php }elseif($contactrequest=='N'){ ?>
                        <li>
                            <a class="fa fa-user-plus bg-blue" href="javascript:void(0)"
                                onclick="showerror('You are not authorize to make connections.');"
                                data-val="<?php echo $profile['user']['id'];?>"></a>


                        </li>
                        <?php } */ ?>
                                <li>
                                    <a href="javascript:void(0)" class="bg-blue <?php echo (isset($totaluserlikes) && $totaluserlikes > 0) ? 'active' : ''; ?> likeprofile<?php echo $count; ?>" id="likeprofile<?php echo $userid; ?>" data-toggle="tooltip" data-val="<?php echo ($userid) ? $userid : null ?>" title="Like"><i class="fa fa-thumbs-up"></i></a>
                                ...
                                <script>
                                    ...
                                    $('.likeprofile<?php echo $count; ?>').click(function() {
                                    ...
                                    var site_url = '<?php echo SITE_URL; ?>/';
                                    /*  Manage friends  */
                                    $('.managefriends<?php echo $count; ?>').click(function() {
                                ...
                                <script>
                                    $('.singlelikeprofile<?php echo $count; ?>').click(function(e) { //alert();
                                        e.preventDefault();
                                        $('#myModallikesvideo').modal('show').find('.modal-body').load($(this).attr(
                                            'href'));
                                    });
                                ...
                                class="bg-blue profileshare<?php echo $count; ?>" data-toggle="tooltip" title="Share"><i
                                ...
                                <li>
                                    <a href="javascript:void(0)" data-val="<?php echo ($userid) ? $userid : '0' ?>" class="sendmessage<?php echo $count; ?> bg-blue" data-toggle="tooltip" title="Send Message"><i class="fa fa-envelope"></i></a>
                                </li>


                                <script>
                                    $('.sendmessage<?php echo $count; ?>').click(function(e) {
                                        e.preventDefault();
                                ...
                                <li>
                                    <a
                                        ...
                                        <?php if ($userid > 0) { ?> data-toggle="modal" data-target="#reportuser" <?php } else { ?> onclick="showerror('You Cannot Report For Yourself.')" <?php } ?>
                                        class="bg-blue"
                                        data-toggle="tooltip"
                                        title="Report">
                        ...
                        <div class="all-cnt-det" style="min-height: 10px;">
                            <h5 class="text-center"><a href="<?php echo SITE_URL; ?>/viewprofile/<?php echo $featuredartist['user_id']; ?>"><?php echo $featuredartist['Profile__name']; ?></a>
                            </h5>

                            <p class="text-center">
                                <?php
                                if (!empty($skills)) {
                                    $skillNames = array_column(array_column($skills, 'skill'), 'name');
                                    $knownskills = implode(', ', $skillNames);
                        ...
                        <?php if ($role_id == NONTALANT_ROLEID) { ?>
                            <div class="btn-book text-center">
                                <a target="_blank" id="booknows" href="<?php echo SITE_URL; ?>/viewprofile/<?php echo $featuredartist['user_id'] ?>" class="btn btn-default">Book Now</a>
                                <a target="_blank" id="askquot" href="<?php echo SITE_URL; ?>/viewprofile/<?php echo $featuredartist['user_id'] ?>" class="btn btn-primary">Ask For Quote</a>
                            </div>
                        <?php } ?>
            ...
            $icondata=$this->Comman->icon($artistvalue['id']);

         ?>
            <div class="owl-item">
                <div class="artistes"> <a
                        href="<?php echo SITE_URL; ?>/viewprofile/<?php echo $artistvalue['profile']['user_id']; ?>"><img
                            src="<?php echo SITE_URL ?>/profileimages/<?php  if($artistvalue['profile']['profile_image']) { echo $artistvalue['profile']['profile_image']; }else{ echo "edit-pro-img-upload.jpg"; }?>"></a>
                    <div class="arist-circle">
                        <div class="artist-inner-circle">
                            <div class="arist-circle-inner"> <a href="#">
                                    <?php foreach($icondata as $value){ 

                  if($value['package_type']=="PR"){
                      $iconimage=$this->Comman->profilepack($value['package_id']);

                    }else if($value['package_type']=="RC"){
                        $iconimage=$this->Comman->recpack($value['package_id']);
                    }else{}
                    ?>
                                    <img src="<?php echo SITE_URL ?>/img/<?php echo $iconimage['icon']?>" />
                                    <?php } ?>
                                </a> </div>
                        </div>
                    </div>
                ...
                <h5><a
                        href="<?php echo SITE_URL; ?>/viewprofile/<?php echo $artistvalue['profile']['user_id']; ?>"><?php echo $artistvalue['profile']['name']; ?></a>
                </h5>
...
<!----------------------Featured jobs---------------------->
<?php if ($featuredReuirment) { //pr($featuredReuirment);  die;
?>
    <section id="col_Featured_jobs" class="featureContainer">
        <div class="container">
            <h2><a href="<?php echo SITE_URL; ?>/featuredjob" target="_blank" style="text-align: center; color: #58595b;">Featured <span>Jobs</a></span></h2>
            <p class="m-bott-50">Jobs Promoted By Users</p>
            <div class="clearfix job-box"></div>

            <?php foreach ($featuredReuirment as $requirement) { //pr($requirement); die;
                $role_id = $this->request->session()->read('Auth.User.role_id');
                $icondata = $this->Comman->icon($requirement['Requirement__user_id']);
            ...
            ?>
                ...
                if ($prpackdatestart <= $currentdate && $currentdate >= $prpackdateend && $prpackdatestart != "1970-01-01 05:30:00" && $prpackdateend != "1970-01-01 05:30:00") {
                    $package_expired = "true";
                } else if ($rcpackdatestart <= $currentdate && $currentdate >= $rcpackdateend && $rcpackdatestart != "1970-01-01 05:30:00" && $rcpackdateend != "1970-01-01 05:30:00") {
                    $package_expired = "true";
                } else {
                ...
                <div class="col-md-6">
                    ...
                    <?php if ($package_expired == "false") { ?>
                        <div class="job-card">
                            <div class="row d-flex align-items-cente">
                                <div class="col-md-3 col-sm-4">
                                    <div class="fea-img">
                                        <?php
                                        if ($requirement['Requirement__image']) { ?>
                                        ...
                                        <div class="arist-circle">
                                            <div class="artist-inner-circle">
                                                <div class="arist-circle-inner">
                                                    <?php $proiconimage = $this->Comman->profilepack($requirement['p_package']); //pr($proiconimage); die;
                                                    if ($proiconimage['icon']) { ?>
                                                        <a href="javascript:void(0)" title="<?php echo $proiconimage['name'] . " Profile Pack"; ?>">
                                                    ...
                                                    <?php $iconimage = $this->Comman->recpack($requirement['r_package']); // pr($iconimage); die;
                                                    if ($iconimage['icon']) { ?>
                                                        <a href="javascript:void(0)" data-toggle="tooltip"
                                                            title="Recruiter Pack : <?php echo $iconimage['title']; ?>">
                                                            <img src="<?php echo SITE_URL ?>/img/<?php echo $iconimage['icon']; ?>" />
                                                        </a>
                                                    <?php } else { ?>
                                                        <a href="javascript:void(0)" data-toggle="tooltip"
                                ...
                                <div class="col-md-9 col-sm-8" style="display:flex; flex-direction:column; align-items:flex-start; justify-content:center;">
                                    <h3 class="heading d-flex align-items-center" style="width:100%;">
                                        <a href="<?php echo SITE_URL ?>/applyjob/<?php echo $requirement['Requirement__id']; ?>" class="flex-fill"><?php echo $requirement['Requirement__title']; ?>
                                        </a>
                                        <span>
                                            <a href="javascript:void(0)" data-toggle="tooltip" title="Last Date and Time of Application" data-placement="top"><?php echo date('M d,Y h:i:a', strtotime($requirement['Requirement__last_date_app'])); ?>
                                            </a>
                                        </span>
                                    </h3>
                                    ...
                                    <p>
                                        <a href="<?php echo SITE_URL; ?>/viewprofile/<?php echo $requirement['Requirement__user_id']; ?>"><?php echo $requirement['name']; ?></a>
                                        <span class="color-a"> | <?php echo $requirement['Requirement__location']; ?></span>
                                    </p>
                                    <?php $talenttype = $this->Comman->requiredetail($requirement['Requirement__id']); //pr($talenttype); 
                                    ?>
                                    <p class="selected">
                                        <?php
                                        $skillNames = array_column(array_column($talenttype, 'skill'), 'name');
                                ...
                                <div class="col-sm-6">
                                    <?php if ($this->request->session()->read('Auth.User.id')) { ?>
                                        <div class="icon-bar srh-icon-bar">
                                            ...
                                            <!-- <a href="javascript:void(0)" class="fa fa-share fb jobshare"
                                                data-link="http://bookanartiste.com/applyjob/<?php //echo $requirement['Requirement__id'] 
                                                                                                ?>"
                                                data-img="<?php //echo SITE_URL . "/job/" . $requirement['Requirement__image'];  
                                                            ?>"
                                                data-title="BookAnArtiste"></a> -->

                                            <div class="share_button jobshare-toggle" style="display: none; top:40px; position: absolute;background-color: rgb(255, 255, 255); color: black;">
                                                <ul class="list-unstyled list-inline text-center clearfix">
                                                    <li class="pull-left">
                                                        <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo SITE_URL; ?>/applyjob/<?php echo ($userid) ? $userid : '0' ?>" class="fb-share-button" data-href="<?php echo SITE_URL; ?>/applyjob/<?php echo $requirement['Requirement__id']; ?>" target="_blank"> <i class="fa fa-facebook"></i>
                                                        </a>
                                                    </li>
                                                    <li class="pull-left">
                                                        <a href="https://plus.google.com/share?url=<?php echo SITE_URL; ?>/applyjob/<?php echo ($userid) ? $userid : '0' ?>" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,height=600,width=600');return false;"><i class="fa fa-google-plus"></i></a>
                                                    </li>
                                                    <li class="pull-left">
                                                        <a href="http://twitter.com/share?url=<?php echo SITE_URL; ?>/applyjob/<?php echo ($userid) ? $userid : '0' ?>" target="_blank"><i class="fa fa-twitter"></i></a>
                                                    </li>

                                                    <li class="pull-left">
                                                        <a href="http://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo SITE_URL; ?>/applyjob/<?php echo ($userid) ? $userid : '0' ?>" target="_blank" title="Share to LinkedIn">
                                                            <i class="fa fa-linkedin"></i>
                                                        </a>
                                                    </li>

                                                    <li class="pull-left"> <a href="javascript:void(0)" class="whatsapps" data-wh="<?php echo SITE_URL; ?>/viewprofile/<?php echo ($userid) ? $userid : '0' ?>"><i class="fa fa-whatsapp"></i></a></li>
                                            ...
                                            <script>
                                                $(document).ready(function() {
                                                    $(".jobshare").click(function() {
                                                        $(".jobshare-toggle").slideToggle();
                                                    });
                                                });
                                            </script>
                                            ...
                                            <a title="Save Job" href="javascript:void(0)" class="fa fa-floppy-o savejobs" data-job="<?php echo $requirement['Requirement__id'] ?>" id="<?php echo $requirement['Requirement__id'] ?>" <?php if (in_array($requirement['Requirement__id'], $savejobarray)) { ?> style="color:red" <?php  } ?> alt="Save Jobs"></a>


                                            <a title="Block Job" href="javascript:void(0)" class="fa fa-ban block" data-job="<?php echo $requirement['Requirement__id'] ?>" id="block<?php echo $requirement['Requirement__id'] ?>" <?php if (in_array($requirement['Requirement__id'], $blockjobarray)) { ?> style="color:red" <?php  } ?> alt="Block Jobs"></a>
            ...
            <?php } ?>
            <?php /* foreach($requirementfeatured as $featuredvalue){ 
                //pr($featuredvalue);
                $icondata=$this->Comman->icon($featuredvalue['user_id']);
                            ?>
                <div class="col-sm-12 job-card">
                    <div class="col-sm-2">
                        <div class="fea-img"> <img src="<?php echo SITE_URL ?>/job/<?php echo $featuredvalue['image'];?>"
            ...
            <div class="col-sm-10">
                ...
                <h3 class="heading"><a
                        href="<?php echo SITE_URL ?>/applyjob/<?php echo $featuredvalue['id'];?>"><?php echo $featuredvalue['title']; ?>
                    </a><span> <?php echo date('d M Y h:m:sa',strtotime($featuredvalue['last_date_app'])); ?></span>
                </h3>
                <p><a
                        href="<?php echo SITE_URL; ?>/viewprofile/<?php echo $featuredvalue['user']['id']; ?>"><?php echo $featuredvalue['user']['profile']['name']; ?></a>
                    <span class="color-a"> | <?php echo $featuredvalue['location']; ?></span>
                </p>
        ...
        <?php if (count($featuredReuirment) > 6) { ?>
            <div class="text-center m-top-20">
...
<section id="col_work_process">
    <div class="container">
        ...
        <p class="m-bott-50">Network, Gigs, No Commission</p>
        <div class="row">
                ...
                <div id="Got-Talent" class="tab-pane fade in active">
                    <div class="container">
                        <ul class="progressbar">
                            <li class="col-sm-3"><a href="<?php //echo SITE_URL; 
                                                            ?>/signup"><img src="images/work_1.png">
                                    <p>Create Profile</p>
                                </a></li>
                            <li class="col-sm-3"><a href="javascript:void(0)"><img src="images/work_2.png">
                                    <p>Build Network</p>
                                </a></li>
                            <li class="col-sm-3"><a href="javascript:void(0)"><img src="images/work_3.png">
                                    <p>Find Work</p>
                                </a></li>
                            <li class="col-sm-3"><a href="javascript:void(0)"><img src="images/work_4.png">
    ...
    box-sizing:border-box;
                            ...
                            .newProgress li:nth-child(6):after {
    display:none;
    }
    </style>

                        <ul class="progressbar newProgress" style="display:flex; flex-wrap:wrap;">
                            <li><a href="<?php //echo SITE_URL; 
                                            ?>/signup"><img src="images/work_1.png">
                                    <p>Sign Up</p>
                                </a></li>
                            <li><a href="javascript:void(0)"><img src="images/work_2.png">
                                    <p>Post Your Requirement</p>
                                </a></li>
                            <li><a href="javascript:void(0)"><img src="images/work_3.png">
                                    <p>Get applications/quotes</p>
                                </a></li>
                            <li><a href="javascript:void(0)"><img src="images/work_4.png">
                                    <p>Shortlist</p>
                                </a></li>
                           <li><a href="javascript:void(0)"><img src="images/work_4.png">
                                    <p>Pay talent directly</p>
                                </a></li>
                            ...
                            <li><a href="javascript:void(0)"><img src="images/work_4.png">
                                    <p>Send booking and Ask for Quote requests</p>
                                </a></li>
                            <li><a href="javascript:void(0)"><img src="images/work_4.png">
                                    <p>Pay talent directly</p>
                                </a></li>
...
<?php echo $how_it_work['description']; ?>


<!----------------------col_so_net---------------------->
<section id="col_so_net">
    <div class="container">
        <h2> <span>Here You Can See</span></h2>
            ...
            <div class="col-sm-7 social-net-blog-cntnt">
                ...
                <div class="row">
                    <div class="col-sm-12 col-xs-6">
                        <div class="pra_sec">
                            <div class="icons_img"><img src="images/acc_2.png"></div>
                            <div class="pra_info netwrk-cntnt">
                                <h6>Social Network</h6>
                                <p> Add Friends, Manage Contacts, Create your own Network of Performers and reach out.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12 col-xs-6">
                        <div class="pra_sec">
                            <div class="icons_img"><img src="images/acc_3.png"></div>
                            <div class="pra_info netwrk-cntnt">
                    ...
                    <div class="col-sm-12 col-xs-6">
                        <div class="pra_sec">
                            <div class="icons_img"><img src="images/acc_4.png"></div>
                            <div class="pra_info netwrk-cntnt">
                    ...
                    <div class="col-sm-12 col-xs-6">
                        <div class="pra_sec">
                            <div class="icons_img"><img src="images/acc_5.png"></div>
                            <div class="pra_info netwrk-cntnt">
                                <h6>Activities</h6>
                                <p>Let others see your likes, dislike and your preferences through the activities board.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12 col-xs-6">
                        <div class="pra_sec">
                            <div class="icons_img"><img src="images/acc_6.png"></div>
                            <div class="pra_info netwrk-cntnt">
                    ...
                    <div class="col-sm-12 col-xs-6">
                        <div class="pra_sec">
                            <div class="icons_img"><img src="images/acc_7.png"></div>
                            <div class="pra_info netwrk-cntnt">
                    ...
                    <div class="col-sm-12 col-xs-6">
                        <div class="pra_sec">
                            <div class="icons_img"><img src="images/acc_8.png"></div>
                            <div class="pra_info netwrk-cntnt">
                                <h6> Collaborate</h6>
                                <p>Post your requirements and find talent that meets your exact requirement.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-xs-6">
                        <div class="pra_sec">
                            <div class="icons_img"><img src="images/acc_9.png"></div>
                            <div class="col-sm-10 netwrk-cntnt">
                                <h6> Maximise Revenue</h6>
                                <p>Pay and Get Paid Directly, we will not charge any commission for work ever.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        if (element) {
            ...
            // }, 500); // Adjust the delay duration (in milliseconds) to your preference
        }
    });
</script>
<!----------------------col_package---------------------->
                        ...
                        ?>
                            <div class="col-sm-4">
                                <div class="package silver">
                                    ...
                                    <div style="text-align:center;"> <strong><?php echo $value['packagetext']; ?></strong>
                                    </div>
                                    <div class="price">
                                        <?php echo "$" . $value['price'] . ".00"; ?><small><span>/</span><?php echo $value['validity_days']; ?>
                                            days</small></div>
                                    <ul class="list-unstyled">
                                        ...
                                        <?php if (in_array('website_visibility', $show_on_home_page)) { ?>
                                            <li><b><?php echo $value['website_visibility']; ?></b> Visibility Of Personal
                                                Website</li>
                                        <?php } ?>
                                        ...
                                        <?php if (in_array('privacy_setting_access', $show_on_home_page)) { ?>
                                            <li>Privacy Setting
                                                Access-<b><?php if ($value['privacy_setting_access'] == 'Y') {
                                                                echo "Yes";
                                                            } else {
                                                                echo "No";
                                                            } ?></b>
                                        ...
                                        <?php if (in_array('access_to_ads', $show_on_home_page)) { ?>
                                            <li>Access To
                                                Advertise-<b><?php if ($value['access_to_ads'] == 'Y') {
                                                                    echo "Yes";
                                                                } else {
                                                                    echo "No";
                                                                } ?></b>
                                        ...
                                        <?php if (in_array('number_job_application', $show_on_home_page)) { ?>
                                            <li><b><?php echo $value['number_job_application']; ?></b> Job Application Per Month
                                            </li>
                                        <?php } ?>
                                        ...
                                        <?php if (in_array('ads_free', $show_on_home_page)) { ?>
                                            <li>AD Free
                                                Experience-<b><?php if ($value['privacy_setting_access'] == 'Y') {
                                                                    echo "Yes";
                                                                } else {
                                                                    echo "No";
                                                                } ?></b>
                                        ...
                                        <?php if (in_array('introduction_sent', $show_on_home_page)) { ?>
                                            <li><b><?php echo $value['introduction_sent']; ?></b> Total No. of Introductions
                                                Sent</li>
                                        <?php } ?>
                                        <?php if (in_array('number_of_intorduction_send', $show_on_home_page)) { ?>
                                            <li><b><?php echo $value['number_of_intorduction_send']; ?></b> Total No. of
                                                Introductions Sent Per Day</li>
                                        <?php } ?>
                                        <?php if (in_array('number_of_introduction', $show_on_home_page)) { ?>
                                            <li><b><?php echo $value['number_of_introduction']; ?></b> Total No. of
                                                Introductions Recieved</li>
                                        <?php } ?>
                                        ...
                                        <?php } ?>
                                        <?php if (in_array('introduction_sent', $show_on_home_page)) { ?>
                                            <li><b> <?php echo $value['introduction_sent']; ?></b> No. of Introduction Send Per
                                                Day</li>
                                        <?php } ?>
                                        <?php if (in_array('ping_price', $show_on_home_page)) { ?>
                                        ...
                                        <?php if (in_array('job_alerts_month', $show_on_home_page)) { ?>
                                            <li><b> <?php echo $value['job_alerts_month']; ?></b> No. of Jobs Alerts Per Month
                                            </li>
                                        <?php } ?>
                                        ...
                                        <?php if (in_array('number_of_free_quote_month', $show_on_home_page)) { ?>
                                            <li><b> <?php echo $value['number_of_free_quote_month']; ?></b> Free Quote Month
                                            </li>
                                        <?php } ?>
                                        <?php if (in_array('number_of_free_day', $show_on_home_page)) { ?>
                                            <li><b> <?php echo $value['number_of_free_day']; ?></b> Ask for Quote’ Request Per
                                                Day</li>
                                        <?php } ?>
                                        ...
                                        <?php if (in_array('number_of_booking', $show_on_home_page)) { ?>
                                            <li><b> <?php echo $value['number_of_booking']; ?></b> Booking Requests Request Per
                                                Job</li>
                                        <?php } ?>
                                        <?php if (in_array('profile_likes', $show_on_home_page)) { ?>
                                            <li><b> <?php echo $value['profile_likes']; ?></b> Total No. of Profile Likes Given
                                                Per Day</li>
                                        <?php } ?>
                                    ...
                                    <ul class="text-center list-inline">
                                        ...
                                        <li class="list-inline-item">
                                            <a href="<?php echo SITE_URL ?>/profilepackage" class="btn btn-primary">Learn
                                                More</a>
                                        </li>
                                    </ul>
                        ...
                        ?>
                            <div class="col-sm-4">
                                <div class="package silver">
                                    ...
                                    <div class="price">
                                        <?php echo "$" . $value['price'] . ".00"; ?><small><span>/</span>Requirement</small>
                                    </div>
                                    <ul class="list-unstyled">
                                    ...
                                    <ul class="list-inline text-center">
                                        <li class="list-inline-item">
                                            <a href="<?php echo SITE_URL; ?>/package/buy/requirementpackage/<?php echo $value['id']; ?>" class="btn btn-default">Choose Plan</a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a href="<?php echo SITE_URL ?>/requirementpackage" class="btn btn-primary">Learn More</a>
                                        </li>
                                    </ul>
                            ...
                            <div class="col-sm-4">
                                <div class="package silver">
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        <!--<li><b> <?php //echo $value['number_of_job_simultancney']; 
                                                    ?></b> Job Simultancney</li>-->
                                        <!--<li><b>    <?php //echo $value['priorites']; 
                                                        ?></b> Job Priorites</li>-->
                                        <li><b> <?php echo $value['nubmer_of_site']; ?></b> Website</li>
                                        <li><b> <?php echo $value['number_of_message']; ?></b> Private Message </li>
                                        <!--<li><b><?php //echo $value['number_of_contact_details']; 
                                                    ?></b> Contact Details </li> -->
                                        <li><b><?php echo $value['number_of_talent_search']; ?></b> Talent Search </li>
                                        <!--<li><b>  <?php //echo $value['lengthofpackage']; 
                                                        ?></b> Length of Package</li>-->
                                        <!--<li><b> <?php //echo $value['multiple_email_login']; 
                                                    ?></b> Multiple email login</li> -->
                                        <!--<li><b> <?php //echo $value['number_of_email']; 
                                                    ?></b> Emails</li>-->
                                        <!--<li><b>  <?php //echo $value['creadit_limit']; 
                                                        ?></b> Credit Limit</li> -->
                                        <!--<li><b> <?php //echo $value['ping_price']; 
                                                    ?> </b> Ping Price</li>-->
                                    ...
                                    <ul class="list-inline text-center">
                                        ...
                                        <li class="list-inline-item">
                                            <a href="<?php echo SITE_URL ?>/package/allpackages/recruiterepackage" class="btn btn-primary">Learn More</a>
                                        </li>
                                    </ul>
    ...
    <div class="modal-dialog">
        ...
        <?php } else { ?>
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Sorry, you are not logedin. Please login to report this user.</p>
                </div>
            </div>
        <?php } ?>
    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        var $element = $('.owl-prev').html("");
        var $element = $('.owl-next').html("");
    });
</script>
