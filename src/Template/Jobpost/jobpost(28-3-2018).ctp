...
<div class="m-top-60 container-fluid">
...
google.maps.event.addDomListener(window, 'load', initialize);
  ...
  <link href="http://192.168.5.53/testwordpress/imagecrop/2/demo/components/imgareaselect/css/imgareaselect-default.css" rel="stylesheet" media="screen">
<link rel="stylesheet" href="http://192.168.5.53/testwordpress/imagecrop/2/demo/css/jquery.awesome-cropper.css">    
              <div class="container">
   ...
   <input id="sample_input" type="hidden" name="profile_image">
      ...
      <?php /* ?>
                  ...
                  <div class="col-sm-4 upload-img text-center">
					 <?php if($requirement['image']){ ?>
			<img src="<?php echo SITE_URL; ?>/job/<?php echo $requirement['image']; ?>" height="123px" width="132px">
             <div><a href="#"><div class="input-file-container">
			<input class="input-file" id="file" type="file" name="image" onchange="return fileValidation()">
			<label tabindex="0" for="my-file" class="input-file-trigger">Upload Image</label>
                          <span id="ncpyss" style= "display: none; color: red">Image Extension Allow .jpg|.jpeg|.png... Format Only</span>
		...
		<?php foreach($Skill as $key=>$value){ //pr($value);?>
		     ...
		     <option value="<?php echo $value['id']; ?>"<?php if(in_array($value['id'], $talentarray)){ ?> selected <?php }?>><?php echo $value['name']; ?></option>
		<?php } ?>
		</select>
</div>
           ...
           <div class="col-sm-3"></div>       
            ...
            <?php echo $this->Form->input('venue_type',array('class'=>'form-control','placeholder'=>'Venue Type','id'=>'','required','label' =>false,'type'=>'text')); ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">  <?php echo $this->Form->input('landmark',array('class'=>'form-control','placeholder'=>'Landmark','id'=>'name','required','label' =>false)); ?>
                  </div>
                  <div class="col-sm-3"></div>
                </div>
