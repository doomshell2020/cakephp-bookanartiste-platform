...
<div class="srch-box">
  <div class="container">
   ...
   top: 243px;">Show Less</a> <?php } ?>
     ...
     <!--          <?php if(empty($_SESSION['advancejobsearch']) && $_SESSION['advancejobsearch']['optiontype']!=1 && empty($title) ){ ?>
          ...
          <div class="form-group">
           ...
           <div class="row"  id="panel">
             ...
             <div class="form-group">
              ...
              <?php  if($_SESSION['advancejobsearch']['role_id']){ ?>
               ...
               <div class="col-sm-2">
                ...
                <input type="text" class="form-control" id="inputEmail3" placeholder="" value="<?php if($_SESSION['advancejobsearch']){  if($_SESSION['advancejobsearch']['role_id']==2){ echo "Artists"; } elseif($_SESSION['advancejobsearch']['role_id']==3) { echo "Non-Telant";} } ?>" readonly>
              </div>
            <?php } ?>  <?php  if($_SESSION['advancejobsearch']['recname']){ ?>
              <div class="col-sm-2">
                <label for="" class=" control-label">Posted by name :</label>
                
                <input type="text" class="form-control" id="inputEmail3" placeholder="" value="<?php if($_SESSION['advancejobsearch']){  echo $_SESSION['advancejobsearch']['recname']; } ?>" readonly>
              </div>
            <?php } ?>
            ...
            <?php  if($_SESSION['advancejobsearch']['event_from_date']){ ?>
              <div class="col-sm-2">
                ...
                <input type="text" class="form-control" id="inputEmail3" placeholder="" value="<?php if($_SESSION['advancejobsearch']){  echo $_SESSION['advancejobsearch']['event_from_date']; } ?>" readonly>
              </div>
            <?php  }?>
            ...
            <?php  if($_SESSION['advancejobsearch']['time']){   ?>
              <div class="col-sm-2">
                ...
                <input type="text" class="form-control" id="inputEmail3" placeholder="" value="<?php if($_SESSION['advancejobsearch']['time']=="Y"){ echo "YES";}else if($_SESSION['advancejobsearch']['time']=="a") {
                 echo "All";
           ...
           <?php  if($_SESSION['advancejobsearch']['event_to_date']){ ?>
            <div class="col-sm-2">
              ...
              <input type="text" class="form-control" id="inputEmail3" placeholder="" value="<?php if($_SESSION['advancejobsearch']){  echo $_SESSION['advancejobsearch']['event_to_date']; } ?>" readonly>
            </div>
          <?php  }?>
          ...
          <?php  if($_SESSION['advancejobsearch']['talent_required_fromdate']){ ?>
            <div class="col-sm-2">
              ...
              <input type="text" class="form-control" id="inputEmail3" placeholder="" value="<?php if($_SESSION['advancejobsearch']){  echo $_SESSION['advancejobsearch']['talent_required_fromdate']; } ?>" readonly>
            </div>
          <?php  }?>
          ...
          <?php  if($_SESSION['advancejobsearch']['talent_required_todate']){ ?>
            <div class="col-sm-2">
              ...
              <input type="text" class="form-control" id="inputEmail3" placeholder="" value="<?php if($_SESSION['advancejobsearch']){  echo $_SESSION['advancejobsearch']['talent_required_todate']; } ?>" readonly>
            </div>
          <?php  }?>
          ...
          <?php  if($_SESSION['advancejobsearch']['last_date_app'] ){ ?>
            <div class="col-sm-2">
              ...
              <input type="text" class="form-control" id="inputEmail3" placeholder="" value="<?php if($_SESSION['advancejobsearch']){  echo $_SESSION['advancejobsearch']['last_date_app']; } ?>" readonly>
            </div>
          <?php  }?>
          ...
          <?php  if($_SESSION['advancejobsearch']['last_date_appbefore'] ){ ?>
            <div class="col-sm-2">
              ...
              <input type="text" class="form-control" id="inputEmail3" placeholder="" value="<?php if($_SESSION['advancejobsearch']){  echo $_SESSION['advancejobsearch']['last_date_appbefore']; } ?>" readonly>
            </div>
    ...
    <div class="col-sm-2"> 
      <a href="<?php echo SITE_URL ?>/search/advanceJobsearch/1" class="btn btn-default btn-block"  <?php if(empty($_SESSION['advancejobsearch']['name']) && $_SESSION['advancejobsearch']['optiontype']==1){ ?> style="margin-left: 30px" <?php } ?>>Edit Search</a> </div>
      <div class="col-sm-2"> 
        <a href="<?php echo SITE_URL ?>/search/advanceJobsearch" class="btn btn-primary btn-block" <?php if(empty($_SESSION['advancejobsearch']['name']) && $_SESSION['advancejobsearch']['optiontype']==1){ ?> style="margin-left: 10px" <?php } ?>>Advance Search</a> </div>
      </div>
                    ...
                    <div class="panel panel-left">
                      ...
                      <form class="form-horizontal"  action="<?php echo SITE_URL ?>/search/search" method="get" id="myajexfrom">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-12">
                           <label class="">
                            <input type="radio" name="time" id="inlineRadio2" value="a" class="auto_submit_item" <?php if($time=="a") {echo "checked"; }else{echo "checked";} ?> >
                          All </label><br>
                          <label class="">
                            <?php if(in_array("N", $continue)){ ?>
                              <input type="radio" name="time" id="inlineRadio1" value="N" class="auto_submit_item"  <?php if($time=="N") {echo "checked"; } ?>>
                            Fixed Time Jobs</label>
                          <?php } ?>

                          <?php if(in_array("Y", $continue)){ ?>
                            <label class="">
                              <input type="radio" name="time" id="inlineRadio2" value="Y" class="auto_submit_item" <?php if($time=="Y") {echo "checked"; } ?> >
                        ...
                        <div class="col-sm-12">
                         <select class="form-control auto_submit_item" name="currency[]" multiple="">
                           ...
                           <?php $i=0; foreach($currencyarray as $key => $value){ ?>
                            <option value="<?php echo $key ?>" <?php if(in_array($key,$currencyarrayset)){ echo "selected"; } ?>> <?php echo  $value; ?> </option>
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-sm-12">
                        ...
                        <select class="form-control auto_submit_item" name="payment[]" multiple="">
                          ...
                          <?php  $i=0;  foreach($payemntfaq as $key => $paymentfaqvalue){ ?>
                            <option value="<?php echo $key ?>" <?php if(in_array($key,$paymentselarray)){ echo"selected"; } ?>> <?php echo  $paymentfaqvalue; ?> </option>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-12">
                         ...
                         <select class="form-control auto_submit_item" name="location[]" multiple="">
                          ...
                          <?php  $i=0;  foreach($location as $key => $locationvalue){ ?>
                            <option value="<?php echo $key ?>" <?php if(in_array($key,$loc)){ echo"selected"; } ?>> <?php echo  $locationvalue; ?> </option>
                        ...
                        <div class="col-sm-12">
                         <select class="form-control  auto_submit_item" name="telenttype[]" multiple="">
                           ...
                           <?php $i=0;  foreach($talentype as $key => $talentypevalue){ ?>
                            <option value="<?php echo $key ?>" <?php if(in_array($key,$ttype)){ echo"selected"; } ?>> <?php echo  $talentypevalue; ?> </option>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-12">
                          <select class="form-control  auto_submit_item" name="eventtype[]" multiple="">
                            ...
                            <?php $i=0; foreach($eventtype as $key => $eventtypevalue){ ?>
                              ...
                              <option value="<?php echo $key ?>" <?php if(in_array($key,$eventtypearray)){ echo"selected"; } ?>> <?php echo  $eventtypevalue; ?> </option>
                        ...
                        <?php if($backtorefine==1){ ?>
                          ...
                          <a href=" <?php echo SITE_URL;?>/search/search?<?php echo $this->request->session()->read('backtorefinesearch'); ?>" class="btn btn-default" >Back to Search Result </a>
                        <?php }else {  ?>
 ...
 //pr($sentquote);
                                   ...
                                   <div class="col-sm-3">
                                    <div class="profile-det-img1">
                                     ...
                                     <div class="img-top-bar"> <a href="<?php echo SITE_URL; ?>/applyjob/<?php echo $value['id'] ?>" target="_blank" ></a> <img src="<?php echo SITE_URL ?>/img/<?php echo $picon['icon'] ?>" style="height: 2%; width: 15%"/> <img src="<?php echo SITE_URL ?>/img/<?php echo $ricon['icon'] ?>" style="height: 2%; width: 15%"/> </div>
...
if( $title && empty($_SESSION['advancejobsearch'])) { ?>
 <div class="row"  id="panel">
  ...
  <div class="srch-box">
    ...
    <div class="form-group">
      <div class="col-sm-2"> 
        <a href="<?php echo SITE_URL ?>/search/advanceJobsearch/1" class="btn btn-default btn-block">Edit Search</a> </div>
        <div class="col-sm-2"> 
              ...
              <?php  if($_SESSION['advancejobsearch']['gender']){ ?>        
                <div class="col-sm-2">
                  ...
                  <input type="text" class="form-control" id="inputEmail3" placeholder="" readonly value="<?php  if($_SESSION['advancejobsearch']){ ?> <?php for($i=0;$i<count($_SESSION['advancejobsearch']['gender']);$i++){
                    ...
                    else if($_SESSION['advancejobsearch']['gender'][$i]=="bmf")echo "Both Male and Female";else if($_SESSION['advancejobsearch']['gender'][$i]=="a") echo "Any,";
                  ...
                  <div class="panel panel-left">
                    ...
                    <form class="form-horizontal"  action="<?php echo SITE_URL ?>/search/search" method="get" id="myajex">
                      ...
                      <div class="form-group">
                       ...
                       <div class="col-sm-12">
                         <label class="">
                          <input type="radio" name="time" id="inlineRadio2" value="a" class="auto_submit" <?php if($time=="a") {echo "checked"; } ?> >
                        All </label><br>
                        <?php if(in_array("N", $continue)){ ?>
                          <label class="">
                            <input type="radio" name="time" id="inlineRadio1" value="N" class="auto_submit"  <?php if($time=="N") {echo "checked"; } ?>>
                          Fixed Time Jobs</label>
                        ...
                        <?php if(in_array("Y", $continue)){ ?>
                          <label class="">
                            <input type="radio" name="time" id="inlineRadio2" value="Y" class="auto_submit" <?php if($time=="Y") {echo "checked"; } ?> >
                          Continuous Job </label>
                        <?php } ?>
