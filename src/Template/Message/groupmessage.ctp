 ...
 <span class="fa fa-folder"></span>
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenu1" >
    ...
    <?php }?>
	   ...
	   <input type="hidden" name="type" id="type" value="i"></div>
          </div>
	      </div>         
      ...
      /*$data=$this->Comman->userdeails($messages_data['created_id']);
      pr($data);*/
             ?>
             ...
             <div class="col-sm-2">
             <input type="checkbox" name="thread_id[]" class="thread_id" id="thread_id" value="<?php echo $messages_data['thread_id']; ?>">
             
             <img src="<?php echo SITE_URL; ?>/profileimages/<?php echo $messages_data['from_image']; ?>" class=" img-circle">
             
             </div>
             <div class="col-sm-1">
             <p class="">
             <?php if($messages_data['total'] > 1){ ?>
             <a href="<?php echo SITE_URL; ?>/message/viewmessagegroup/<?php echo $messages_data['thread_id']; ?>">
             <?php }else{?>
             <a href="<?php echo SITE_URL; ?>/message/viewmessagegroup/<?php echo $messages_data['id']; ?>">
             <?php }?>
             <?php if($messages_data['read_status']=='Y'){ ?>
             <?php echo $messages_data['group_name']; ?>
             <?php }else{?>
             <strong><?php echo $messages_data['group_name']; ?></strong>
             <?php }?>
             ...
             <a href="<?php echo SITE_URL; ?>/message/viewmessagegroup/<?php echo $messages_data['thread_id']; ?>">(<?php echo $messagescount; ?>)
             ...
             <?php 
             if(date("d-m-y",strtotime($messages_data['groupcreated']))==date('d-m-y'))
             {
		echo " Today ";
             }
             else
             {
		echo date("d M Y ",strtotime($messages_data['groupcreated']));    
             }
             echo date("h:i a",strtotime($messages_data['groupcreated'])); ?>
