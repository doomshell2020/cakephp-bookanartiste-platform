                      ...
                      <div class="ff">
                          ...
                          <span class="dropdown">
                              ...
                              <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                  <li><a href="Javascript:void(0)" class="changefolder" data-val="0">inbox</a></li>
                                  <?php foreach ($folders as $folders_data) { ?>

                                      <li><a href="Javascript:void(0)" class="changefolder" data-val="<?php echo $folders_data['id']; ?>"><?php echo $folders_data['folder_name']; ?></a></li>
                                  <?php } ?>
                              </ul>
                          </span>
                                ...
                                ?>
                                      <?php if ($messages_data['from_id'] != $this->request->session()->read('Auth.User.id')) { ?>
                                          <div class="row inbox-row box" id="row_<?php echo $messages_data['id']; ?>">
                                              ...
                                              <div class="col-sm-2"><img src="<?php echo SITE_URL; ?>/profileimages/<?php echo $messages_data['from_image']; ?>" class=" img-circle pull-left">
                                                  <p class="pull-right">
                                                  ...
                                                  <p>
                                                      <?php if ($messages_data['total'] > 1) { ?>
                                                          ...
                                                          <?php } else { ?>
                                                              ...
                                                              <?php } else { ?>
                                                                  <strong><?php echo $messages_data['subject']; ?> <?php if ($messages_data['total'] > 1) {
                                                                                                                        echo "(" . $messages_data['total'] . ")";
                                                                                                                    } ?></strong>
                                                              <?php } ?>
                                                              </a>
                                              ...
                                              <div class="col-sm-3 time">
                                                  <p>
                                                      <?php
                                                        if (date("d-m-y", strtotime($messages_data['created'])) == date('d-m-y')) {
                                                            echo "Today ";
                                                        } else {
                                                            echo date("d M Y", strtotime($messages_data['created']));
                                                        }
                                                        echo date("h:i a", strtotime($messages_data['created'])); ?>
                                      ...
                                      <?php } else { ?>
                                          <div class="row inbox-row box" id="row_<?php echo $messages_data['id']; ?>">
                                              <div class="col-sm-1"><input type="checkbox" name="thread_id[]" class="thread_id" id="thread_id" value="<?php echo $messages_data['thread_id']; ?>"></div>
                                              <div class="col-sm-2"><img src="<?php echo SITE_URL; ?>/profileimages/<?php echo $messages_data['to_image']; ?>" class=" img-circle pull-left">
                                                  <p class="pull-right">
                                                      <?php if ($messages_data['total'] > 1) { ?>
                                                          <a href="<?php echo SITE_URL; ?>/message/viewmessage/<?php echo $messages_data['thread_id']; ?>">
                                                          <?php } else { ?>
