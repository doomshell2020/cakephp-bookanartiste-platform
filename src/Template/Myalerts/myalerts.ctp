        ...
        <div class="col-sm-3">
          <div class="panel panel-left">
            <ul class=" alrt-categry list-unstyled">
              ...
              <?php
              // pr('skjhksjhk');exit;
              $allalerts = count($jobapplicationalerts) + count($bookingapplicationalerts) + count($quoteapplicationalerts) + count($quoteapplicationreceivedalerts) + count($quoterevisedalerts) + count($pingalerts) + count($applicationsentalerts) + count($sendaquotealerts) + count($bookingreceived) + count($quotereceive) + count($pingsent); ?>
              <li class="active">
                <a href="#" class="jobalerts" data-action="alerts">All</a><span class="noti_f"><?php echo $allalerts; ?></span>
              </li>
            ...
            <form>
              ...
              ?>
                <div id="<?php echo $applicationrec['id']; ?>" class="member-detail row alerts applicationreceived">
                  ...
                  <?php if ($applicationrec['user']['profile']['profile_image'] != '') { ?>
                    <div class="col-sm-3">
                      <div class="member-detail-img">
                        ...
                        <div class="img-top-bar"> <a href="<?php echo SITE_URL ?>viewprofile" class="fa fa-user"></a> </div>
                      </div>
                    </div>
                  <?php } else { ?>
                    <div class="col-sm-3">
                  ...
                  <div class="box_hvr_checkndlt">
                    ...
                    <a href="#" class="delete_jobalerts pull-right dlt_prfl_box" data-val="<?php echo $applicationrec['id'] ?>" data-action="jobapplication" onclick="confirmDelete(event)"> <i class="fa fa-times" aria-hidden="true"></i></a>
              ...
              ?>
                <div id="<?php echo $bookingrecapp['id']; ?>" class="member-detail row alerts bookingsent">
                  ...
                  <div class="box_hvr_checkndlt">
                    <span class="pull-left"><input type="checkbox" value=""></span>
                    <a href="#" class="delete_jobalerts pull-right dlt_prfl_box" data-action="jobapplication" data-val="<?php echo $bookingrecapp['id'] ?>" onclick="confirmDelete(event)"><i class="fa fa-times" aria-hidden="true"></i></a>
                  </div>
                </div>
              <?php } ?>
              ...
              ?>
                <div id="<?php echo $quoterecapp['id']; ?>" class="member-detail row alerts quoterequest">
                  ...
                  <div class="box_hvr_checkndlt">
                    <span class="pull-left"><input type="checkbox" value=""></span>
                    <a href="#" class="delete_jobalerts pull-right dlt_prfl_box" data-action="jobquote" data-val="<?php echo $quoterecapp['id'] ?>" onclick="confirmDelete(event)"><i class="fa fa-times" aria-hidden="true"></i></a>
                  </div>
                </div>
              <?php } ?>
              ...
              ?>
                <div id="<?php echo $quotereceialerts['id']; ?>" class="member-detail row alerts quotereceived">
                  ...
                  <div class="box_hvr_checkndlt">
                    <span class="pull-left"><input type="checkbox" value=""></span>
                    <a href="#" class="delete_jobalerts pull-right dlt_prfl_box" data-action="jobquote" data-val="<?php echo $quotereceialerts['id'] ?>" onclick="confirmDelete(event)"><i class="fa fa-times" aria-hidden="true"></i></a>
                  </div>
                </div>
              <?php } ?>
              ...
              ?>
                <div id="<?php echo $quotrevisedale['id']; ?>" class="member-detail row alerts quoterevised">
                  ...
                  <div class="box_hvr_checkndlt">
                    <span class="pull-left"><input type="checkbox" value=""></span>
                    <a href="#" class="delete_jobalerts pull-right dlt_prfl_box" data-action="jobquote" data-val="<?php echo $quotrevisedale['id'] ?>" onclick="confirmDelete(event)"><i class="fa fa-times" aria-hidden="true"></i></a>
                  </div>
                </div>
              <?php } ?>
              ...
              ?>
                <div id="<?php echo $pingreceivedalerts['id']; ?>" class="member-detail row alerts pingreceived">
                  ...
                  <div class="box_hvr_checkndlt">
                    <span class="pull-left"><input type="checkbox" value=""></span>
                    <a href="#" class="delete_jobalerts pull-right dlt_prfl_box" data-action="jobapplication" data-val="<?php echo $pingreceivedalerts['id'] ?>" onclick="confirmDelete(event)"><i class="fa fa-times" aria-hidden="true"></i></a>
                  </div>
                </div>
              <?php } ?>
              ...
              ?>
                <div class="member-detail row alerts quotesent">
                  ...
                  <div class="box_hvr_checkndlt">
                    <span class="pull-left"><input type="checkbox" value=""></span>
                    <a href="#" class="delete_jobalerts pull-right dlt_prfl_box" data-action="jobquote" data-val="<?php echo $pingreceivedalerts['id'] ?>" onclick="confirmDelete(event)"><i class="fa fa-times" aria-hidden="true"></i></a>
                  </div>
                </div>
              <?php } ?>
              ...
              ?>
                <div class="member-detail row alerts pingsent">
                  ...
                  <div class="box_hvr_checkndlt">
                    <span class="pull-left"><input type="checkbox" value=""></span>
                    <a href="#" class="delete_jobalerts pull-right dlt_prfl_box" data-action="jobapplication" data-val="<?php echo $pingsentalert['id'] ?>" onclick="confirmDelete(event)"><i class="fa fa-times" aria-hidden="true"></i></a>
                  </div>
                </div>
              <?php } ?>
...
<script>
  function confirmDelete(event) {
    event.preventDefault(); // Prevent the default action (in this case, following the link)

    // Display the confirmation dialog
    if (confirm('Are you sure you want to delete?')) {
      // If the user confirms, continue with the deletion action
      var link = event.target.closest('a'); // Find the closest 'a' element (the delete link)
      if (link) {
        var action = link.getAttribute('data-action'); // Get the data-action attribute value
        var value = link.getAttribute('data-val'); // Get the data-val attribute value
        // Perform the deletion action here (e.g., send an AJAX request to delete the item)
      }
    }
  }
</script>
