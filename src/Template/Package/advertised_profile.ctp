   ...
   <div class="row">
     ...
     <div class="col-sm-12">
       <div class="signup-popup">
         <h2>My Profile Advertisement Campaign List</h2>
         <p>Details of the my earlier Profile advertisements in the last 180 days</p>
   ...
   <table id="example1" class="table table-bordered table-striped">
    ...
    <tbody id="example2">
              ...
              if(isset($profile) && !empty($profile)){ 
		              foreach($profile as $admin){  //pr($admin); 
                    $currentdate=date('Y-m-d H:m:s');
                $todates= date('Y-m-d H:m:s',strtotime($admin['ad_date_to'])); 

                $fromdate= date('M d, Y',strtotime($admin['ad_date_from'])); 
                $todate= date('M d, Y',strtotime($admin['ad_date_to'])); 
                ...
                if ($totaldays < 180) {
                    ...
                    <a href="<?php echo SITE_URL; ?>/viewprofile/<?php echo $admin['id']; ?>" target="_blank"><?php echo $admin['rname']; ?></a>
