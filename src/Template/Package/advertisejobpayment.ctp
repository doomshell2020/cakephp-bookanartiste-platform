     ...
     <div class="col-sm-8">
       <div class="signup-popup">
         ...
         <div class="row">
          ...
          <div class="">
            $<?php echo $bannerpackid['req_ad_total']; ?> for <?php  echo $number_of_days; ?> days.
          </div>
          </div>
          ...
          <div class="col-sm-6">
            <div>
             <h5>Total Amount Before Tax: <span><?php echo "$".$bannerpackid['req_ad_total']; ?> </span></h5>
          </div>
          ...
          <div class="">
             <h5>Total Bill Amount: <span><?php $grandtotal=$bannerpackid['req_ad_total']+($bannerpackid['req_ad_total']*$totaltax/100); echo "$".$grandtotal; ?></span></h5>
           </div>
        ...
        <?php echo $this->Form->create('Package',array('url' => array('controller' => 'Package', 'action' => 'proadjobpay'),'type'=>'file','inputDefaults'=>array('div'=>false,'label'=>false),'class'=>'form-horizontal','id'=>'PackageIndexForm','autocomplete'=>'off')); ?>
        
        <input type="hidden" name="before_tax_amt" value="<?php echo $bannerpackid['req_ad_total']; ?>">
        <input type="hidden" name="package_price" value="<?php echo $grandtotal; ?>">

        <input type="hidden" name="job_id" value="<?php echo $bannerpackid['requir_id']; ?>">
        <input type="hidden" name="advrt_job_id" value="<?php echo $bannerpackid['id']; ?>">
        <input type="hidden" name="package_id" value="<?php echo $bannerpackid['id']; ?>">
