     ...
     <div class="col-sm-8">
       <div class="signup-popup">
         ...
         <div class="row">
          ...
          <div class="">
            <?php echo "Profile Advertisement"; ?>
          </div>
        ...
        <?php echo $this->Form->create('Package',array('url' => array('controller' => 'Package', 'action' => 'proadprofilepay'),'type'=>'file','inputDefaults'=>array('div'=>false,'label'=>false),'class'=>'form-horizontal','id'=>'PackageIndexForm','autocomplete'=>'off')); ?>
        ...
        <input type="hidden" name="job_id" value="<?php echo $bannerpackid['id']; ?>">
