...
<!----------------------editprofile-strt------------------------>
 ...
 <h4>Package Details</h4>
	...
	<h5>Package Name</h5>
       ...
       <div>
	<?php echo $pcakgeinformation['name']." Featured Job Package"; ?>
    </div>
...
<?php echo $this->Form->create('Package',array('url' => array('controller' => 'Package', 'action' => 'processfjpayment'),'type'=>'file','inputDefaults'=>array('div'=>false,'label'=>false),'class'=>'form-horizontal','id'=>'PackageIndexForm','autocomplete'=>'off')); ?>
