...
<!----------------------editprofile-strt------------------------>
 ...
 <div class="">
   <?php echo $pcakgeinformation['name']." Featured Profile Package"; ?>
 </div>
 ...
 <div class="">
   $<?php echo $package_price; ?> for <?php if($number_of_days>0){ echo $number_of_days; }else { echo $pcakgeinformation['validity_days']; } ?> day  <?php  ?>
 </div>
</div>

  <div class="col-sm-6">
  <div>
   <h5>Total Amount Before Tax: <span><?php echo "$".$package_price; ?> </span></h5>
</div>
...
<div class="">
   <h5>Total Bill Amount: <span><?php $grandtotal=$package_price+($package_price*$totaltax/100); echo "$".$grandtotal; ?></span></h5>
 </div>
...
<?php echo $this->Form->create('Package',array('url' => array('controller' => 'Package', 'action' => 'processfppayment'),'type'=>'file','inputDefaults'=>array('div'=>false,'label'=>false),'class'=>'form-horizontal','id'=>'PackageIndexForm','autocomplete'=>'off')); ?>
    ...
    <input type="hidden" name="package_price" value="<?php echo $grandtotal; ?>">
  	<input type="hidden" name="before_tax_amt" value="<?php echo $package_price; ?>">
    ...
    <?php } } ?>
  	...
  	<input type="hidden" name="number_of_days" value="<?php if($number_of_days>0){ echo $number_of_days; }else { echo $pcakgeinformation['validity_days']; } ?>">
