<!----------------------editprofile-strt------------------------>
<section id="page_signup" class="complete_Purchase">
  <div class="container">
    ...
    <div class="row top_s">
      <div class="col-sm-12">
        <div class="signup-popup">
          ...
          <hr>
          <?php if ($package_id == 0) {
            $package_t = "Free Posting";
          } else {
            $package_t = 'Paid Posting Option';
          } ?>
          <div class="row">
            <div class="col-sm-6">
              <div>
              ...
              <div>
                <?php echo $pcakgeinformation['name'] . " " . $package_t; ?>
              </div>
            ...
            <div class="col-sm-6 pbox_info ">
              <div>
                <h5> <span class="detail_H">Total Amount Before Tax </span>: <span><?php echo "$" . $pcakgeinformation['price']; ?> </span></h5>
              </div>
              ...
              ?>
                  <div class="">
                    <h5><span class="detail_H">Add</span>:<span><?php echo $value['title'] . "@" . $value['tax_percentage'] . "%"; ?></span></h5>
                  </div>
              <?php }
              } else {
              ...
              <div class="">
                <h5><span class="detail_H">Total Bill Amount</span>: <span><?php $grandtotal = $pcakgeinformation['price'] + ($pcakgeinformation['price'] * $totaltax / 100);
                                                                            echo "$" . $grandtotal; ?></span></h5>
              </div>

              <div class="">
                <h5><span class="detail_H">View Price in Local Currency</span>: <span><a target="_blank" href="https://www.xe.com/currencyconverter/">Click Here</a></span></h5>
              </div>
            </div>
          ...
          <?php echo $this->Form->create('Package', array('url' => array('controller' => 'Package', 'action' => 'processrepayment'), 'type' => 'file', 'inputDefaults' => array('div' => false, 'label' => false), 'class' => 'form-horizontal', 'id' => 'PackageIndexForm', 'autocomplete' => 'off')); ?>
