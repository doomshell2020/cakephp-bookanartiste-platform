...
<div id="slider-range"></div>
  ...
  <div class="form-group">
    <div class="col-sm-12">
        ...
        <div class="col-sm-12">
       <?php echo $this->Form->input('ethnicity',array('class'=>'form-control', 'id'=>'','label' =>false,'empty'=>'--Select Ethnicity--','options'=>$ethnicityfetch,'selected'=>'selected')); ?>
  ...
  <div class="form-group">
    <div class="col-sm-12">
        ...
        <div class="col-sm-12">
            <?php echo $this->Form->input('profile_active',array('class'=>'form-control','id'=>'profileactivein','label' =>false,'empty'=>'--Select Profile Active IN--','options'=>$profileactivedetect)); ?>
             <input type="hidden" name="slideragevalue" id="sliderrangevalueset">
    </div>
  </div>
...
$(document).ready(function(){  //alert();
	...
	<div class="prosrrc">
     ...
     <a href="#" class="fa fa-remove"></a></div>
   <img src="<?php echo SITE_URL; ?>/profileimages/<?php echo $friendss['profile_image'];  ?>" onerror="this.onerror=null;this.src='<?php echo SITE_URL ?>/images/job.jpg';">
...
<?php if ($subrepa){ ?>
   ...
   <div class="all-cnt-det"><h5 class="text-center"><a href="<?php echo SITE_URL; ?>/viewprofile/<?php echo $friendss['user_id']; ?> "><?php echo $friendss['name']; ?></a></h5>
   ...
   <p class="text-center"><?php if($skills)
     ...
     <a href="<?php echo SITE_URL; ?>/viewprofile/<?php echo $friendss['user_id'];  ?>" class="btn btn-default">Book</a>
      <a href="<?php echo SITE_URL; ?>/viewprofile/<?php echo $friendss['user_id'];  ?>" class="btn btn-primary">Ask For Quote</a>
     </div>
     </div>
     <?php } ?>
    </div>
