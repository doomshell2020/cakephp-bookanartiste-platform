...
?>
	...
	// ajax call to get event detail from database.
		...
		function get_events_information(date){
			$.ajax({
				type:'POST',
				url: site_url+'profile/calendarinformation',
		...
		$(document).ready(function(){
			...
			//	var todo = $('#eventtd').val();
				...
				$.ajax({
					...
					data:'fun_type=add_event_information&date='+date+'&title='+title+'&reminder='+radioValue+'&desc='+desc+'&eventdate='+eventdate,
