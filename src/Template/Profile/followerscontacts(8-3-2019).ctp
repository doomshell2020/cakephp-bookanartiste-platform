...
$(document).ready(function(){  //alert();
 ...
 <div id="Followers" class="tab-pane fade">
     ...
     <div class="row">
		 <div class="prosrrc">
		 <?php  foreach($followerd as $followerdss){  //pr($followingss);?>
    ...
    <?php } ?>
     <a href="<?php echo SITE_URL; ?>/viewprofile/<?php echo $followerdss['from_id']; ?>" class="fa fa-user"></a> 
...
<?php if ($subrepa){ ?>
   ...
   <div class="all-cnt-det"><h5 class="text-center"><a target="_blank" href="<?php echo SITE_URL; ?>/viewprofile/<?php echo $followerdss['user_id']; ?>"><?php echo $followerdss['name']; ?></a></h5>
   ...
   <p class="text-center"><?php if($skills)
     ...
     <p class="text-center"><?php echo $followerdss['location']; ?></p></div>
     
     <div class="btn-book text-center">
     <a target="_blank" href="<?php echo SITE_URL; ?>/viewprofile/<?php echo $followerdss['user_id']; ?>" class="btn btn-default">Book</a>
