<?php foreach ($following as $friendss) { //pr($ethnicityfetch);
    ...
    <div class="talent_tab">
      ...
      <ul class="nav nav-pills">
        ...
        if ($profile['user']['id'] > 0 && $profile['user']['id'] == $id) { ?>
          ...
          <li class="active"><a data-toggle="" href="<?php echo SITE_URL ?>/profile/followingcontacts/<?php echo $profile['user']['id']; ?>" class="cnt" data-action="following">Following (<?php echo count($following); ?>)</a></li>
                ...
                <div class="col-sm-4">
                  <div class=" profile-det">
                    ...
                    <div class="allcontact-social">
                      ...
                      <?php $contactrequest = $this->Comman->contactreqstatus($followingss['user_id']); ?>
                      <?php if ($contactrequest == 'R') { ?>
                        <a href="javascript:void(0)" class="fa fa-user-plus bg-blue" title="Request Received"></a>

                      <?php } elseif ($contactrequest == 'S') { ?>
                        <a id="add_friend<?php echo $followingss['user_id']; ?>" class="managefriends fa fa-handshake-o" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" href="javascript:void(0)" data-val="<?php echo $followingss['user_id']; ?>" data-action="cancel" title="Cancel Request"></a>

                      <?php } elseif ($contactrequest == 'C') { ?>
                        <a id="add_friend<?php echo $followingss['user_id']; ?>" class="managefriends fa fa-handshake-o" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" href="javascript:void(0)" data-val="<?php echo $followingss['user_id']; ?>" data-action="remove" title="Cancel Request"></a>

                      <?php } else { ?>
                        <a id="add_friend<?php echo $followingss['user_id']; ?>" class="dropdown-toggle managefriends fa fa-user-plus" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" href="javascript:void(0)" data-val="<?php echo $followingss['user_id']; ?>" data-action="connect"> </a>
                      <?php
                      } ?>

                      <a href="<?php echo SITE_URL; ?>/message/sendmessage/<?php echo ($followingss['user_id']) ? $followingss['user_id'] : '0' ?>" data-val="<?php echo ($followingss['user_id']) ? $followingss['user_id'] : '0' ?>" class="sendmessage" data-toggle="modal" data-target="#sendmessage" title="Send Message"><i class="fa fa-envelope"></i></a>
                      <a data-toggle="tooltip" href="javascript:void(0)" class="profileshare<?php echo $followingss['user_id']; ?>" data-toggle="tooltip" title="Share"><i class="fa fa-share"></i></a>

                      <div class="share_button profileshare-toggle<?php echo $followingss['user_id']; ?>" style="display: none;">
                        <ul class="list-unstyled list-inline text-center">
                          <li>
                            <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo SITE_URL; ?>/viewprofile/<?php echo ($followingss['user_id']) ? $followingss['user_id'] : '0' ?>" class="fb-share-button"
                              data-href="<?php echo SITE_URL; ?>/gallery/<?php echo $videos_data['video_name']; ?>" target="_blank"> <i class="fa fa-facebook fa-lg"></i>
                            </a>
                          </li>
                          <li>
                            <a href="https://plus.google.com/share?url=<?php echo SITE_URL; ?>/viewprofile/<?php echo ($followingss['user_id']) ? $followingss['user_id'] : '0' ?>" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,height=600,width=600');return false;"><i class="fa fa-google-plus fa-lg"></i></a>
                          </li>
                          <li>
                            <a href="http://twitter.com/share?url=<?php echo SITE_URL; ?>/viewprofile/<?php echo ($followingss['user_id']) ? $followingss['user_id'] : '0' ?>" target="_blank"><i class="fa fa-twitter fa-lg"></i></a>
                          </li>

                          <li>
                            <a href="http://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo SITE_URL; ?>/viewprofile/<?php echo ($followingss['user_id']) ? $followingss['user_id'] : '0' ?>" target="_blank" title="Share to LinkedIn" class="fa fa-linkedin fa-lg">
                            </a>
                          </li>

                          <li> <a href="javascript:void(0)" class="fa fa-whatsapp fa-lg whatsapps" data-wh="<?php echo SITE_URL; ?>/viewprofile/<?php echo ($followingss['user_id']) ? $followingss['user_id'] : '0' ?>"></a></li>

                        </ul>
                      </div>

                      <a href="javascript:void(0)" class="likesactive <?php echo (isset($likesuser) && $likesuser > 0) ? 'active' : ''; ?>" id="likeprofile<?php echo $followingss['user_id']; ?>" data-toggle="tooltip" data-val="<?php echo ($followingss['user_id']) ? $followingss['user_id'] : '0' ?>" title="Like"><i class="fa fa-thumbs-up"></i></a>
                    ...
                    <div class="all-cnt-det">
                      <h5 class="text-center"><a target="_blank" href="<?php echo SITE_URL; ?>/viewprofile/<?php echo $followingss['user_id']; ?>"><?php echo $followingss['name']; ?></a></h5>
                      ...
                      <p class="text-center"> <a style="color:black;" target="_blank" href="<?php echo SITE_URL; ?>/viewprofile/<?php echo $friendss['user_id']; ?> "><?php echo $followingss['location']; ?></a></p>
                    </div>

                    <div class="btn-book text-center">
                      <a target="_blank" href="<?php echo SITE_URL; ?>/viewprofile/<?php echo $followingss['user_id']; ?>" class="btn btn-default">Book Now</a>
