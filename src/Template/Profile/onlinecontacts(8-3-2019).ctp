...
$(document).ready(function(){  //alert();
  ...
  <img src="<?php echo SITE_URL; ?>/profileimages/<?php echo $onlinesss['profile_image'];  ?>" onerror="this.onerror=null;this.src='<?php echo SITE_URL ?>/images/job.jpg';">
    ...
    <?php } ?>
     <a href="<?php echo SITE_URL; ?>/viewprofile/<?php echo $onlinesss['from_id']; ?>" class="fa fa-user"></a> 
...
<?php if ($subrepa){ ?>
   ...
   <div class="all-cnt-det"><h5 class="text-center"><a target="_blank" href="<?php echo SITE_URL; ?>/viewprofile/<?php echo $onlinesss['user_id']; ?>"><?php echo $onlinesss['name']; ?></a></h5>
   ...
   <p class="text-center"><?php if($skills)
     ...
     <p class="text-center"><?php echo $onlinesss['location']; ?></p></div>
