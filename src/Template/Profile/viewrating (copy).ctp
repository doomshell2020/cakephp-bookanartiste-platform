		...
		<tr>
                <td>  <b><?php echo R1; ?> </b></td>
                      <td><fieldset id='demo1' class="ratingusers">
                        ...
                        <label class = "full" for="starr15 <?php echo $reviewusers['id']; ?>" title="Awesome - 5 stars"></label>
                        ...
                        <label class="half" for="starr14half <?php echo $reviewusers['id']; ?>" title="Pretty good - 4.5 stars"></label>
                        ...
                        <label class = "full" for="starr14 <?php echo $reviewusers['id']; ?>" title="Pretty good - 4 stars"></label>
                        ...
                        <label class="half" for="starr13half <?php echo $reviewusers['id']; ?>" title="Meh - 3.5 stars"></label>
                        ...
                        <label class = "full" for="starr13 <?php echo $reviewusers['id']; ?>" title="Meh - 3 stars"></label>
                        ...
                        <label class="half" for="starr12half <?php echo $reviewusers['id']; ?>" title="Kinda bad - 2.5 stars"></label>
                        ...
                        <label class = "full" for="starr12 <?php echo $reviewusers['id']; ?>" title="Kinda bad - 2 stars"></label>
                        ...
                        <label class="half" for="starr11half <?php echo $reviewusers['id']; ?>" title="Meh - 1.5 stars"></label>
                        ...
                        <label class = "full" for="starr11 <?php echo $reviewusers['id']; ?>" title="Sucks big time - 1 star"></label>
                        ...
                        <label class="half" for="starr1half <?php echo $reviewusers['id']; ?>" title="Sucks big time - 0.5 stars"></label>
                    </fieldset></td>
              </div> 
	     ...
	     <tr>
                <td> <b><?php echo R2; ?> </b></td>
                      <td><fieldset id='demo2' class="ratingusers">
                        ...
                        <label class = "full" for="starr25<?php echo $reviewusers['id']; ?>" title="Awesome - 5 stars"></label>
                        ...
                        <label class="half" for="starr24half<?php echo $reviewusers['id']; ?>" title="Pretty good - 4.5 stars"></label>
                        ...
                        <label class = "full" for="starr24<?php echo $reviewusers['id']; ?>" title="Pretty good - 4 stars"></label>
                        ...
                        <label class="half" for="starr23half<?php echo $reviewusers['id']; ?>" title="Meh - 3.5 stars"></label>
                        ...
                        <label class = "full" for="starr23<?php echo $reviewusers['id']; ?>" title="Meh - 3 stars"></label>
                        ...
                        <label class="half" for="starr22half<?php echo $reviewusers['id']; ?>" title="Kinda bad - 2.5 stars"></label>
                        ...
                        <label class = "full" for="starr22<?php echo $reviewusers['id']; ?>" title="Kinda bad - 2 stars"></label>
                        ...
                        <label class="half" for="starr21half<?php echo $reviewusers['id']; ?>" title="Meh - 1.5 stars"></label>
                        ...
                        <label class = "full" for="starr21<?php echo $reviewusers['id']; ?>" title="Sucks big time - 1 star"></label>
                        ...
                        <label class="half" for="starr2half<?php echo $reviewusers['id']; ?>" title="Sucks big time - 0.5 stars"></label>
                    </fieldset></td>
                     </div>  </tr>
	    ...
	    <tr>
                 <td> <b><?php echo R3; ?> </b></td>
                      ...
                      <td><fieldset id='demo3' class="ratingusers">
                        ...
                        <label class = "full" for="starr35<?php echo $reviewusers['id']; ?>" title="Awesome - 5 stars"></label>
                        ...
                        <label class="half" for="starr34half<?php echo $reviewusers['id']; ?>" title="Pretty good - 4.5 stars"></label>
                        ...
                        <label class = "full" for="starr34<?php echo $reviewusers['id']; ?>" title="Pretty good - 4 stars"></label>
                        ...
                        <label class="half" for="starr33half<?php echo $reviewusers['id']; ?>" title="Meh - 3.5 stars"></label>
                        ...
                        <label class = "full" for="starr33<?php echo $reviewusers['id']; ?>" title="Meh - 3 stars"></label>
                        ...
                        <label class="half" for="starr32half<?php echo $reviewusers['id']; ?>" title="Kinda bad - 2.5 stars"></label>
                        ...
                        <label class = "full" for="starr32<?php echo $reviewusers['id']; ?>" title="Kinda bad - 2 stars"></label>
                        ...
                        <label class="half" for="starr31half<?php echo $reviewusers['id']; ?>" title="Meh - 1.5 stars"></label>
                        ...
                        <label class = "full" for="starr31<?php echo $reviewusers['id']; ?>" title="Sucks big time - 1 star"></label>
                        ...
                        <label class="half" for="starr3half<?php echo $reviewusers['id']; ?>" title="Sucks big time - 0.5 stars"></label>
                    </fieldset></td>
               </div> </tr>
              ...
              <tr>
                 <td> <b><?php echo R4; ?> </b></td>
                      ...
                      <input class="stars" type="radio" id="starr45<?php echo $reviewusers['id']; ?>" name="r4<?php echo $reviewusers['id']; ?>" value="5" <?php if($reviewusers['r4']==5){ echo "checked"; }?>  disabled />
                        <label class = "full" for="starr45<?php echo $reviewusers['id']; ?>" title="Awesome - 5 stars"></label>
                        ...
                        <label class="half" for="starr44half<?php echo $reviewusers['id']; ?>" title="Pretty good - 4.5 stars"></label>
                        ...
                        <label class = "full" for="starr44<?php echo $reviewusers['id']; ?>" title="Pretty good - 4 stars"></label>
                        ...
                        <label class="half" for="starr43half<?php echo $reviewusers['id']; ?>" title="Meh - 3.5 stars"></label>
                        ...
                        <label class = "full" for="starr43<?php echo $reviewusers['id']; ?>" title="Meh - 3 stars"></label>
                        ...
                        <label class="half" for="starr42half<?php echo $reviewusers['id']; ?>" title="Kinda bad - 2.5 stars"></label>
                        ...
                        <label class = "full" for="starr42<?php echo $reviewusers['id']; ?>" title="Kinda bad - 2 stars"></label>
                        ...
                        <label class="half" for="starr41half<?php echo $reviewusers['id']; ?>" title="Meh - 1.5 stars"></label>
                        ...
                        <label class = "full" for="starr41<?php echo $reviewusers['id']; ?>" title="Sucks big time - 1 star"></label>
                        ...
                        <label class="half" for="starr4half<?php echo $reviewusers['id']; ?>" title="Sucks big time - 0.5 stars"></label>
                    </fieldset></td>
             </div> 
	   </tr>
	   <tr>
                 <td><b><?php echo R5; ?> </b></td>
                   ...
                   <input class="stars" type="radio" id="starr55<?php echo $reviewusers['id']; ?>" name="r5<?php echo $reviewusers['id']; ?>" value="5" <?php if($reviewusers['r5']==5){ echo "checked"; }?>  disabled />
                        <label class = "full" for="starr55<?php echo $reviewusers['id']; ?>" title="Awesome - 5 stars"></label>
                        ...
                        <label class="half" for="starr54half<?php echo $reviewusers['id']; ?>" title="Pretty good - 4.5 stars"></label>
                        ...
                        <label class = "full" for="starr54<?php echo $reviewusers['id']; ?>" title="Pretty good - 4 stars"></label>
                        ...
                        <label class="half" for="starr53half<?php echo $reviewusers['id']; ?>" title="Meh - 3.5 stars"></label>
                        ...
                        <label class = "full" for="starr53<?php echo $reviewusers['id']; ?>" title="Meh - 3 stars"></label>
                        ...
                        <label class="half" for="starr52half<?php echo $reviewusers['id']; ?>" title="Kinda bad - 2.5 stars"></label>
                        ...
                        <label class = "full" for="starr52<?php echo $reviewusers['id']; ?>" title="Kinda bad - 2 stars"></label>
                        ...
                        <label class="half" for="starr51half<?php echo $reviewusers['id']; ?>" title="Meh - 1.5 stars"></label>
                        ...
                        <label class = "full" for="starr51<?php echo $reviewusers['id']; ?>" title="Sucks big time - 1 star"></label>
                        ...
                        <label class="half" for="starr5half<?php echo $reviewusers['id']; ?>" title="Sucks big time - 0.5 stars"></label>
                    </fieldset></td>
          </div> 
