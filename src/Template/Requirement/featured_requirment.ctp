   ...
   <div class="row">
     ...
     <div class="col-sm-12">
       <div class="signup-popup">
         <h2>My Featured Requirements</h2>
              ...
              if(isset($Job) && !empty($Job)){ 
                   ...
                   // echo $admin['feature_job_date'];
                    ...
                    <tr>
                      ...
                      <td><?php if($admin['feature_job_date']){ echo $expiredate; }else{ echo "N/A"; } ?></td>                      
                      <td>
                        <?php 
                      ...
                      <td>
                        <span class="label label-success">
                          <?php if($expiredate >= date('Y-m-d H:m:s')){ echo "Featured"; }else{ echo "N/A"; } ?>
                        </span>
                      </td>
