...
<div id="aplybutton" style="visibility:hidden;">
  <div class="container">   
     ...
     <div class="pull-right top-three-but"> 
        ...
        <a herf="<?php echo SITE_URL ?>" value="1" class="btn btn-default m-right-20 actbut psendquote" data-toggle="modal" data-target=""  style="display:none">Purchease  Quote</a>
    </div>
    </div>
    </div>
  ...
  <div class="pull-right top-three-but"> 
       ...
       <button type="submit" form="multiple" value="2" class="btn btn-primary m-right-20 actbut send" >Send Quote</button>
        ...
        <button type="button" value="1" class="btn btn-default m-right-20 actbut psendquote" data-toggle="modal" data-target=""  style="display:none">Purchease  Quote</button>
        ...
        <div class="clearfix m-top-20">
          <div class="col-sm-3">
            <div class="panel panel-left">
              ...
              <form class="form-horizontal"   action="<?php echo SITE_URL ?>/search/advanceRefine" method="get">
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-12">
                    ...
                    <option value="0">Select Payment</option>
                      ...
                      <option value="<?php echo $key ?>"  > <?php echo  $paymentfaqvalue; ?> </option>
               ...
               <?php $i++; } ?>  
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-12">
                      ...
                      <option value="<?php echo $key ?>"  > <?php echo  $talentypevalue; ?> </option>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-12">
                    ...
                    <option value="0">Select Event</option>
                      ...
                      <option value="<?php echo $eventtypevalue ?>"  > <?php echo  $eventtypevalue; ?> </option>
...
if($max<$vacancy['payment_amount']){$max=$vacancy['payment_amount'];}
        ...
        <?php  } }  }?>
           ...
           <div class="row">   <div class="col-sm-12 m-top-20"> <a href="#" class="btn btn-default m-right-20"data-toggle="modal" data-target="#savejobrefinetamplate">Save Search Result </a><a href="#" class="btn btn-primary">View All</a> </div></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <?php  } else{echo "<h3 align='center'>No Jobs Found</h3>";} ?>
    </div>
  </section>
