        ...
        <div class="clearfix m-top-20">
          <div class="col-sm-3">
            <div class="panel panel-left">
              ...
              <form class="form-horizontal"  action="<?php echo SITE_URL ?>/search/jobrefine" method="get">
                <div class="form-group">
...
<a href="<?php echo SITE_URL ?>/viewprofile/<?php echo  $value['postedid'] ?>"><?php echo $value['user_name'] ?></a>
            </li>
            <li><a href="#" class="fa fa-location-arrow"></a>
...
if($max<$vacancy['payment_amount']){$max=$vacancy['payment_amount'];}
            ...
            <div class="row">
              ...
              <div class="col-sm-5 text-right">
                <div class="icon-bar"> 
                <a href="javascript:void(0)" class="fa fa-thumbs-up likejobs" data-job="<?php echo $value['id'] ?>" id="like<?php echo $value['id'] ?>"></a>
                 <a href="#" class="fa fa-share"></a> 
                   <a href="#" class="fa fa-paper-plane-o"></a>
