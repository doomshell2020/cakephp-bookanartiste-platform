      ...
      <div class="container">
        <div class="row m-top-20">
              ...
              <form class="form-horizontal" id="telentrefine">
                ...
                ?>
                  <div class="form-group">
                    ...
                    <?php foreach ($querytionarray as $key => $value) {
                    ?>
                      ...
                      <div class="col-sm-12">
                        <select class="form-control" name="vitalstats[<?php echo  $value['vque']['question']; ?>]">
                          <option>Select <?php echo  $value['vque']['question']; ?> </option>
          ...
          <div class="col-sm-9" id="data">
              ...
              ?>
                  <div class="member-detail  box row">
                    ...
                    <div class="col-sm-9 boc_gap">
                      ...
                      <a href="<?php echo SITE_URL ?>/viewprofile/<?php echo $value['id']  ?>" class="btn btn-default ad">Add Friend</a>
                      <a href="<?php echo SITE_URL ?>/viewprofile/<?php echo $value['id']  ?>" class="btn btn-default qot">Ask For Quote</a>
                      <a href="<?php echo SITE_URL ?>/viewprofile/<?php echo $value['id']  ?>" class="btn btn-default cnt">Connect</a>
                    </div>
                    <div class="icon-bar">
            ...
            <div class="row">
              <div class="col-sm-12"><a href="#" class="btn btn-default"> Save Search Result </a></div>
            </div>
          </div>
        </div>
      </div>
...
<?php  } else {
  echo "<h3 align='center'>No Talent's Found</h3>";
}   ?>