<div id="job-<?php echo $id ?>">
  ...
  <div class="form-group">
    <label for="email">
      <a href="<?php echo SITE_URL ?>/applyjob/<?php echo $requirement_data['id']; ?>" target="_blank"><?php echo $requirement_data['title']; ?></a>
    </label>
  ...
  <div class="form-group">
    ...
    <div class="input-group">
      <span class="input-group-addon" id="prefixcode<?php echo $id ?>"><?php echo $requirement_data['requirment_vacancy'][0]['currency']['symbol']  ?></span>
      <input type="number" class="form-control" patten="^[0-9]*$" name="amt" required>
  ...
  function myfunction(x) {
    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        $('#prefixcode' + reqid).text(obj.code);
      },
      complete: function() {
