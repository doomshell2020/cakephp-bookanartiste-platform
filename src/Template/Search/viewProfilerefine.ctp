            ...
            <div class="panel panel-left">
             ...
             <?php foreach($languageknownarray as $key => $value){ ?>
                ...
                <div class="form-group">
                 ...
                 <?php  $i=0; foreach($querytionarray as $key=> $value){  if($value['option_value_id']!=0) {   ?>
               ...
               <?php } ?> 
                ...
                <div class="form-group Review">
                  ...
                  <div class="col-sm-12">  <fieldset id='demo6' class="rating">
...
<script type="text/javascript">
      ...
      $.ajax({
       ...
       beforeSend: function() {
            ...
            success:function(response){
                 ...
                 if(response=="<h3 align='center'>No Talent's Found</h3>"){ $('#data').html(response)}else{
  ...
  <?php  } else{ echo "<h3 align='center' style='margin-top:350px'>No Talent's Found</h3>";}   ?>
