...
<div id="page-wrapper">
  ...
  ?>
    ...
    <section id="page_search-job_result">
      ...
      <h2>Saved Job <span>Search Results</span></h2>
      <p class="m-bott-50"></p>
            ...
            <div class="form-group">
              ...
              <?php if ($_SESSION['advancejobsearch']['time']) {   ?>
                <div class="col-sm-2">
                  ...
                  <input type="text" class="form-control" id="inputEmail3" placeholder="" value="<?php echo ($_SESSION['advancejobsearch']['time']); ?>" readonly>
                </div>
              <?php  } ?>
