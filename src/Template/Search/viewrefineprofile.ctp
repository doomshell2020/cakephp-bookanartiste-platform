...
?>
  <section id="page_search_result">
    ...
    <div class="container">
      <h2>Saved <span> Profile Result</span></h2>
                  ...
                  <div class="col-sm-12">
                    <select class="form-control" name="ethnicity">
                      ...
                      <?php foreach ($Enthicity as $key => $Enthicity) { ?>
                        <option value="<?php echo $key ?>" <?php if ($ethnicity == $key) {
                                                              echo "selected";
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-12">
                    <select class="form-control" name="workingstyle">
                      ...
                      <option value="P" <?php if ($workstyle == "P") {
                                          echo "selected";
                                        } ?>>Professional</option>
                      <option value="A" <?php if ($workstyle == "A") {
                                          echo "selected";
                                        } ?>>Amateur</option>
                      <option value="PT" <?php if ($workstyle == "PT") {
                                            echo "selected";
                                          } ?>>Part time</option>
                      <option value="H" <?php if ($workstyle == "H") {
                                          echo "selected";
                                        } ?>>Hobbyist</option>
                    </select>
                  </div>
              ...
              ?>
                  ...
                  <div class="member-detail  box row">
                    <div class="box_hvr_checkndlt chkprofile">
                      ...
                      <a href="javascript:void(0);" class="delete_jobalerts pull-right dlt_prfl_box" data-widget="remove" data-action="prosearch" data-val="<?php echo $value['id'] ?>"><i class="fa fa-times" aria-hidden="true"></i>
                      </a>
                      ...
                      <div class="row">
                        ...
                        <ul class="col-sm-6">
                          ...
                          <li><?php
                              ...
                              ?></li>
                          <li><?php
                              $data = $this->Comman->userskills($value['user_id']);
                              foreach ($data as $skillvalue) {
