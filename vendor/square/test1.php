...
<html>
  <head>
    ...
    var applicationId = 'sq0idp-lK20wMyUuYoQM6S66tk16w'; // <-- Add your application's ID here
  ...
  <body>
    ...
    <div id="sq-card-number">4032031348895581</div>
    <label>CVV</label>
    <div id="sq-cvv">111</div>
    <label>Expiration Date</label>
    <div id="sq-expiration-date">10/18</div>
